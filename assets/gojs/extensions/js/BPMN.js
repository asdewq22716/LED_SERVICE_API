...
*/
  ...
  var newteak = $(go.Brush, "Linear", { 0: "PaleGreen", 1: "PaleGreen" });
  ...
  var GatewayNodeSize = 50;
  var GatewayNodeSymbolSize = 30;
  var GatewayNodeWidth = 120;
  var GatewayNodeHeight = 80;
  ...
  $(go.Node, "Vertical",
    ...
    $(go.Panel, "Spot",
      ...
      $(go.Shape, "RoundedRectangle",  // the inner "Transaction" rounded rectangle
        ...
        new go.Binding("visible", "isTransaction")),$(go.TextBlock,  // the center text
        ...
        $(go.Panel, "Spot",
          $(go.Shape, "Circle",  // Outer circle
            { strokeWidth: 1,
              ...
              ,fromSpot: go.Spot.AllSides, toSpot: go.Spot.LeftSide
            },
...
$(go.Shape, "NotAllowed",
	    ...
	    var eventNodeTemplate2ForPalette =
    $(go.Node, "Auto",
      { locationObjectName: "SHAPE",
        locationSpot: go.Spot.Center,
        //toolTip: tooltiptemplate
...
var SpaceNode =
    $(go.Node, "Table",  
        ...
        $(go.Panel, "Auto", 
          $(go.Shape, "LineH",
            { fill: '', strokeWidth: 0,margin: 20 ,width:'100%' }), 
        ) 
      ); // end go.Node Vertical	  
...
//// Block เงื่อนไข
  var gatewayNodeTemplate =
    $(go.Node, "Vertical",
     ...
     $(go.Panel, "Auto",
      { name: "PANEL",
          minSize: new go.Size(GatewayNodeWidth, GatewayNodeHeight),
          desiredSize: new go.Size(GatewayNodeWidth, GatewayNodeHeight)
      },
      new go.Binding("desiredSize", "size", go.Size.parse).makeTwoWay(go.Size.stringify),
       $(go.Panel, "Spot",
        $(go.Shape, "Diamond",  // the outside rounded rectangle
          { name: "SHAPE",
              fill: GatewayNodeFill, stroke: GatewayNodeStroke,
            parameter1: 10, // corner size
            portId: "", fromLinkable: true, toLinkable: true, cursor: "pointer"
...
//         ),
      ...
      $(go.Panel, "Spot",
        $(go.Shape, "Diamond",
          { strokeWidth: 1, fill: GatewayNodeFill, stroke: GatewayNodeStroke, name: "SHAPE",
            desiredSize: new go.Size(GatewayNodeSize / 0.8, GatewayNodeSize / 1.2)
          }),

      $(go.TextBlock,
        { alignment: go.Spot.Center, textAlign: "center", margin: 0, editable: false },
        new go.Binding("text")),
        $(go.Shape, "NotAllowed",
  ...
  $(go.Node, "Auto",
     { background: GradientLightGray,locationObjectName: "SHAPE", locationSpot: go.Spot.Left,
       resizable: true, resizeObjectName: "PANEL",
      // toolTip: tooltiptemplate,
       selectionAdorned: false 
     },
    ...
    $(go.Panel, "Auto",
      { name: "PANEL",
          minSize: new go.Size(GatewayNodeSize*2, GatewayNodeSize*0.8),
          desiredSize: new go.Size(GatewayNodeSize*2, GatewayNodeSize*0.8)
      },
      new go.Binding("desiredSize", "size", go.Size.parse).makeTwoWay(go.Size.stringify),
       $(go.Panel, "Spot",
        $(go.Shape, "Annotation",  
          ...
          new go.Binding("fill", "GradientLightGray"),
          new go.Binding("strokeWidth", "isCall",
               function(s) { return s ? ActivityNodeStrokeWidthIsCall : ActivityNodeStrokeWidth; })
         )
        ),  // end main body rectangles spot panel
      $(go.TextBlock,  // the center text
        { alignment: go.Spot.Center, textAlign: "left", margin: 5,
          editable: true
        },
        new go.Binding("text").makeTwoWay()),
  ...
  var annotationNodeTemplate_old =
    $(go.Node, "Auto",
      { background: GradientLightGray, locationSpot: go.Spot.Center,
resizable: true, resizeObjectName: "PANEL",selectionAdorned: false	  },
      new go.Binding("location", "loc", go.Point.parse).makeTwoWay(go.Point.stringify),
      $(go.Shape, "Annotation", // A left bracket shape
		{ fill: "white" },
        { portId: "", fromLinkable: true, cursor: "pointer", fromSpot: go.Spot.LeftSide, strokeWidth: 2, stroke: "gray" }),
      $(go.TextBlock,
...
var annotationNodeForPalette =
    $(go.Node, "Auto",
      { background: GradientLightGray, locationSpot: go.Spot.Center,
resizable: true, resizeObjectName: "PANEL",selectionAdorned: false	  },
      new go.Binding("location", "loc", go.Point.parse).makeTwoWay(go.Point.stringify),
      $(go.Shape, "Annotation", // A left bracket shape
		{ fill: "white", desiredSize: new go.Size(GatewayNodeSize / 0.8, GatewayNodeSize / 2) },
        { portId: "", fromLinkable: true, cursor: "pointer", fromSpot: go.Spot.LeftSide, strokeWidth: 1, stroke: "#666666" }),
      $(go.TextBlock,
        { margin: 5, editable: true },
        new go.Binding("text").makeTwoWay()),
		makePort("L", go.Spot.Left, go.Spot.Left, true, true)
 ...
 var poolGroupTemplate =
  ...
  nodeTemplateMap.add("event2", eventNodeTemplate2); 
  ...
  palNodeTemplateMap.add("event2", eventNodeTemplate2ForPalette);
  palNodeTemplateMap.add("space", SpaceNode);
  palNodeTemplateMap.add("gateway", gatewayNodeTemplateForPalette);
  palNodeTemplateMap.add("annotation", annotationNodeForPalette);
    ...
    $(go.Link,
	  ...
	  contextMenu:
          $(go.Adornment, "Vertical",
           ...
           fromSpot: go.Spot.AllSides, toSpot: go.Spot.AllSides,
           reshapable: true, relinkableFrom: true, relinkableTo: true,resegmentable: true, toEndSegmentLength: 20,adjusting: go.Link.Stretch
      },
      new go.Binding("points").makeTwoWay(),
      $(go.Shape, { stroke: "black", strokeWidth: 1,strokeDashArray:null },
				new go.Binding("strokeDashArray", "isDefault", function(s) {
                    if (s === null) return "";
                    return s ? null :[4, 2] ; })),
...
//  });
  ...
  //------------------------------------------  Palette   ----------------------------------------------
    ...
    function makePort_bk(name, align, spot, output, input) {
      var horizontal = align.equals(go.Spot.Top) || align.equals(go.Spot.Bottom);
      // the port is basically just a transparent rectangle that stretches along the side of the node,
      // and becomes colored when the mouse passes over it
      return $(go.Shape,
  ...
  myPaletteLevel1.model = $(go.GraphLinksModel,
    {
      ...
      // -------------------------- Event Nodes
        ...
        { key: 0, category: "space", text: ""},
		{ key: 1, category: "activity", text: "ขั้นตอน", item: "generic task", taskType: 0},
		{ key: 2, category: "activity", text: "ขั้นตอน", item: "generic task", taskType: 0 ,"color": newteak},
        { key: 3, category: "gateway", text: "เงื่อนไข", gatewayType: 0},
		{ key: 4, category: "annotation", text: "หมายเหตุ"},
        { key: "5", "text": "Pool", "isGroup": "true", "category": "Pool" },
          { key: "Lane5", "text": "Lane 1", "isGroup": "true", "group": "5", "color": "white", "category": "Lane" },
          { key: "Lane6", "text": "Lane 2", "isGroup": "true", "group": "5", "color": "white", "category": "Lane" },
        { key: 6, category: "event", text: "Start",   eventType: 1, eventDimension: 1, item: "start"},
        { key: 7, category: "event2", text: "End",     eventType: 1, eventDimension: 8, item: "End"}
      ]  // end nodeDataArray
    });  // end model
/*  myPaletteLevel1.model = $(go.GraphLinksModel,
    {
      ...
      // -------------------------- Event Nodes
       ...
       // { key: 103, category: "event", text: "Timer",   eventType: 3, eventDimension: 3, item: "Timer"},
        { key: 104, category: "event2", text: "End",     eventType: 1, eventDimension: 8, item: "End"},
      ...
      // -------------------------- Task/Activity Nodes
        { key: 131, category: "activity", text: "ขั้นตอน", item: "generic task", taskType: 0},
      ...
      //  { key: 201, category: "gateway", text: "Parallel", gatewayType: 1},
        { key: 204, category: "gateway", text: "เงื่อนไข", gatewayType: 0},
     ...
     //   { key: 401, category: "privateProcess", text: "Black Box"},
        { key: "501", "text": "Pool 1", "isGroup": "true", "category": "Pool" },
          { key: "Lane5", "text": "Lane 1", "isGroup": "true", "group": "501", "color": "white", "category": "Lane" },
          { key: "Lane6", "text": "Lane 2", "isGroup": "true", "group": "501", "color": "white", "category": "Lane" },
        { key: 701, category: "annotation", text: "หมายเหตุ"}
      ]  // end nodeDataArray
    });  // end model
*/
