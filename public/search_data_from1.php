...
if ($_GET["proc"] != "edit") {
    ...
    if ($_GET['sh1'] == 'Mediate') {
        $GET_SYSTEM_ID = '4'; //ข้อมูลที่เกี่ยวข้องกับบุคคลในระบบไกล่เกลี่ย
    } else if ($_GET['sh1'] == 'Bankrupt') {
        $GET_SYSTEM_ID = '2'; //ข้อมูลที่เกี่ยวข้องกับบุคคลในระบบล้มละลาย
    } else if ($_GET['sh1'] == 'Revive') {
        $GET_SYSTEM_ID = '3'; //ข้อมูลที่เกี่ยวข้องกับบุคคลในระบบฟื้นฟู
    } else if ($_GET['sh1'] == 'Backoffice') {
        $GET_SYSTEM_ID = '5';
    } else if ($_GET['sh1'] == 'Civil') {
        $GET_SYSTEM_ID = '1'; //ข้อมูลที่เกี่ยวข้องกับบุคคลในแพ่ง
    }
    /*  echo "<br><br><br><br><br><pre>";
    print_r($_GET);
    echo "</pre>"; */
    $GET_T_NO_BLACK = $_GET['prefixBlackCase'];
    $GET_TO_BLACK_CASE = $_GET['blackCase'];
    $GET_TO_BLACK_YY = $_GET['blackYy'];
    $GET_TO_T_RED_CASE = $_GET['prefixRedCase'];
    $GET_TO_RED_CASE = $_GET['redCase'];
    $GET_TO_RED_YY = $_GET['redYy'];

    $GET_COURT_CODE = $_GET['CourtCode'];
    $GET_COURT_NAME = $_GET['courtName'];

    $_REQUEST["TO_PERSON_ID"] = '1311100009189';

    $_REQUEST["cmd_show_type"] = '1';
    $_REQUEST["proc"] = 'add';
    /* stop AK */
...
$arr_data = [
    'prefixBlackCase' => $GET_T_NO_BLACK,
    'blackCase' => $GET_TO_BLACK_CASE,
    'blackYy' => $GET_TO_BLACK_YY,
    'prefixRedCase' => $GET_TO_T_RED_CASE,
    'redCase' => $GET_TO_RED_CASE,
    'redYy' => $GET_TO_RED_YY,
    'CourtCode' => $GET_COURT_CODE
];
...
$A1 = ($dataReturn['Data'][0]['Plaintiff2'] == "") ? "" : " , ";
$A2 = ($dataReturn['Data'][0]['Plaintiff3'] == "") ? "" : " , ";
$B1 = ($dataReturn['Data'][0]['Deffendant2'] == "") ? "" : " , ";
$B2 = ($dataReturn['Data'][0]['Deffendant3']) == "" ? "" : " , ";
$GET_PLAINTIFF = $dataReturn['Data'][0]['Plaintiff1'] . $A1 . $dataReturn['Data'][0]['Plaintiff2'] . $A2 . $dataReturn['Data'][0]['Plaintiff3'];
$GET_DEFENDANT = $dataReturn['Data'][0]['Deffendant1'] . $B1 . $dataReturn['Data'][0]['Deffendant2'] . $B2 . $dataReturn['Data'][0]['Deffendant3'];
/* echo "<br><br><br><br><br><pre>";
print_r($_GET);
echo "</pre>";
...
<head>
    <script src="./js_system/search_data_from1.js?<?php echo rand(); ?>"></script>
</head>
        ...
        <div class="row" id="animationSandbox">
            <div class="col-md-12">
                <div class="main-header">
                    ...
                    <div class="f-right">
                        <a class="btn btn-danger waves-effect waves-light" href="search_data.php?REGISTERCODE=<?php echo $_GET['REGISTERCODE'] ?>" role="button"><i class="icofont icofont-home"></i> กลับหน้าหลัก</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div id="wf_space" class="card-block">
                        <form id="frm-input" method="post" action="search_data_process.php">
                            ...
                            <input type="hidden" name="SEND_COURT_NAME" id="SEND_COURT_NAME" value="<?php echo $GET_COURT_NAME ?>">
                            <input type="hidden" name="case_sh1" id="case_sh1" value="<?php echo $_GET['sh1'] ?>">
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div id="SEND_TO_BSF_AREA" class="col-md-2 wf-left">
                                    ...
                                    <select name="SYSTEM_ID" id="SYSTEM_ID" class="form-control" tabindex="-1" aria-hidden="true" required onChange="showFormPerType();">
                                        ...
                                        <?php
                                        if ($GET_SYSTEM_ID != '') {
                                            $fill_GET_ID = " AND CMD_SYSTEM_ID ='" . $GET_SYSTEM_ID . "'";
                                        } else {
                                        ?> <option value="" disabled selected>เลือกระบบงาน</option><?php
                                                                                                }
                                                                                                $sql = "SELECT
										*
									  FROM M_CMD_SYSTEM
                            ...
                            <span id="show_form_source_input">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div id="CASE_TYPE_BSF_AREA" class="col-md-5 wf-left">
                                        <select readonly name="COURT_CODE" id="COURT_CODE" class="form-control <?php echo ($inputReadonly != "") ? "" : "select2 select2-hidden-accessible" ?>" tabindex="-1" aria-hidden="true" required>

                                            <?php
                                            if ($GET_COURT_NAME != '') {
                                                $fill_GET_COURT = " AND COURT_NAME ='" . $GET_COURT_NAME . "'";
                                            } else {
                                            ?> <option value="" disabled selected>ศาล</option><?php
                                                                                            }
												...
												";
                                                                                            ...
                                                                                            while ($recCourt = db::fetch_array($queryCourt)) {
                                                                                                ?>
                                                <option readonly value="<?php echo $recCourt['COURT_CODE']; ?>" <?php echo ($GET_COURT_NAME == $recCourt['COURT_NAME']) ? "selected" : ""; ?>><?php echo  $recCourt['COURT_NAME']; ?></option>
                                            <?php
                                                                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div id="PLAINTIFF_PRE_NAME_AREA" class="col-md-8 wf-left">
                                        <input type="text" name="D_C" id="D_C" class="form-control" readonly value="<?php echo $GET_PLAINTIFF; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div id="DEPT_NAME" class="col-md-8 wf-left">
                                        <input type="text" name="D_NAME" id="D_NAME" class="form-control" readonly value="<?php echo $GET_DEFENDANT; ?>">
                            ...
                            <span id="hide_form_send_to" style="<?php echo ($rec_cmd["CMD_FIX_DATE_STATUS"] == 'Y') ? "display:none;" : "" ?>">
                                ...
                                <!--     <div id="CASE_TYPE_BSF_AREA" class="col-md-2 ">
                                        <button type="button" class="btn btn-secondary" onClick="modal_case();">เลือกคดี</button>
                                    </div>
 -->
                            ...
                            <div class="form-group row">
                                ...
                                <div id="SEND_TO_BSF_AREA" class="col-md-5 wf-left">
								  ...
								  WHERE		1=1 
                                  AND A.REGISTER_CODE ='" . $_REQUEST["TO_PERSON_ID"] . "'
                                            ...
                                            <div class="table-responsive">
                                                <table id="wfsflow-1441" class="table table-bordered sorted_table">
                                                    <thead class="bg-primary">
                                                        <tr class="bg-primary">
                                                            <th style="width: 5%;" class="text-center">ลำดับ</th>
                                                            <th style="width:10%;" class="text-center">ประเภทเอกสาร</th>
                                                            <th style="width:10%;" class="text-center">แนบไฟล์</th>
    ...
    <div class="modal fade bd-example-modal-lg modal_case" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">ข้อมูลคดี</h4>
                </div>
               <!--  <div class="container"> -->
                <div >
                    <div align="center" id="table_reture"></div>
                </div>
                <div class="modal-footer">
                    <!--  <button type="button" class="btn btn-danger" onclick="approve_cancel();">ยืนยัน</button> -->
    ...
    <script type="text/javascript">
        ...
        /* start function getCasePersonData */
                ...
                success: function(response) {
                    if (type == 1) {
                        ...
                        $.each(data, function(key, data_value) {
                            ...
                            if (data_value.PREFIX_NAME == "") {
                                let v_PREFIX_NAME = "";
                            }
                            var full_name = (data_value.PREFIX_NAME == null ? "" : data_value.PREFIX_NAME) + '' + data_value.FIRST_NAME + ' ' + (data_value.LAST_NAME == null ? "" : data_value.LAST_NAME);
                            tb_person += "<tr>";
                            tb_person += "<td><label><input type=\"checkbox\" name=\"LIST_REGISTER_CODE_SEND[" + data_value.REGISTER_CODE + "]\" id=\"LIST_REGISTER_CODE" + data_value.REGISTER_CODE + "\" value=\"" + data_value.REGISTER_CODE + "\" " + checkedIdCard + "> " + i + "</label></td>";
                        ...
                        $('#wfs_show_person_send').html('');
                        $('#wfs_show_person_send').append(tb_person);
                        $('select.select2').select2({
                            allowClear: true,
                            placeholder: function() {
                                $(this).data('placeholder');
        ...
        /* stop function getCasePersonData */
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(data, function(key, data_value) {
                        ...
                        tb_asset += "<td><select name=\"CASE_TYPE[" + data_value.ASSET_ID + "]\" id=\"CASE_TYPE_" + data_value.ASSET_ID + "\"  class=\"form-control select2\" tabindex=\"-2\"></select></td>";
        ...
        <?php
        if (($_GET["proc"] == "" || $_GET["proc"] == 'add') && $_GET["REF_ID"] == "") {
        ?>
            $(document).ready(function() {
                getCasePersonData(1);
                getCaseAsset(1);
