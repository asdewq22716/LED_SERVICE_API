                                            ...
                                            ?> <option value="" disabled selected>ศาล</option><?php
												...
												";
                                                                                            ...
                                                                                            while ($recCourt = db::fetch_array($queryCourt)) {
                                                                                                ?>
                                                <option value="<?php echo $recCourt['COURT_CODE']; ?>" <?php echo ($GET_COURT_NAME == $recCourt['COURT_NAME']) ? "selected" : ""; ?>><?php echo  $recCourt['COURT_NAME']; ?></option>
                                            <?php
                                                                                            }
                                            ?>
                                        </select>
