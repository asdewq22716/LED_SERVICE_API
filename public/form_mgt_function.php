...
get_wfs_show1('WFS_FORM_<?php echo $WFS; ?>','form_main.php','W=<?php echo $W; ?>&WFD=<?php echo $WFD; ?>&WFS=<?php echo $WFS; ?>&WFR=<?php echo $WFR_ID; ?>&F_TEMP_ID=<?php echo $F_TEMP_ID; ?>&wfp=<?php echo $_REQUEST['wfp']; ?>','GET');
<?php if($_POST["WF_POP"]!="P"){ ?>
