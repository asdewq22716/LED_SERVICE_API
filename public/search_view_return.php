                    ...
                    <div class="md-input-file">
                      ...
                      <span class="md-line"></span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="wf-right">
                                    <button type="button" onclick="reply_com('<?php echo  $_GET['ID']; ?>','<?php echo $_GET['TO_PERSON_ID']; ?>','<?php echo $_GET['REF_ID_MAIN']; ?>');" class="btn btn-success waves-effect waves-light"><i class="icofont icofont-tick-mark" title=""></i> ตอบกลับ</button>
                                </div>
                            </div>
                        </div>
                        <!-- stop AK  -->
                        <script type="text/javascript">
                            ...
                            $(document).ready(function() {
                                        ...
                                        function() {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(msg) {
                                                    console.log(msg)
                                                    self.location.href = 'search_data_cmd.php?';
                                                }
                                            });
                                        });
                                });
                                ...
                                $("#reply_com").click(function() {
                                    ...
                                    /* self.location.href='search_view.php?REF_ID=<?php echo $_GET["ID"]; ?>&SEND_TO=<?php echo $_GET["SEND_TO"]; ?>&TO_PERSON_ID=<?php echo $_GET["TO_PERSON_ID"]; ?>'; */
                                    self.location.href = 'search_data_cmd.php?';
                                });
                            ...
                            function reply_com(REF_ID, TO_PERSON_ID,REF_ID_MAIN) {

                                window.location = 'cmd_add_from_send_to_return.php?REF_ID=' + REF_ID + '&SEND_TO=<?php echo $_GET["SEND_TO"]; ?>&TO_PERSON_ID=<?php echo $_GET["TO_PERSON_ID"]; ?>&REF_ID_MAIN='+REF_ID_MAIN
                            }
