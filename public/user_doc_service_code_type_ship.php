...
?>
    ...
    $sql = "SELECT * FROM M_BOAT_TYPE_MAP ORDER BY BOAT_TYPE_CODE_LAW ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทเรือ</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสประเภทเรือ</th>
                                <th class="text-center">ชื่อประเภทเรือ</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['BOAT_TYPE_CODE_LAW'];?></td>
                                <td><?php echo $data['BOAT_TYPE_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="ship_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัสประเภทเรือ</th>
                              <th class="text-center">ชื่อประเภทเรือ</th>
    ...
    <script>
    function Export(){
      $("#ship_table").table2excel({
        filename: "ship_type_code"
      });
    }
    </script>
    <!-- footer part start-->
