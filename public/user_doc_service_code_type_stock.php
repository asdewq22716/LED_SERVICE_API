...
?>
    ...
    $sql = "SELECT * FROM M_STOCK_TYPE_MAP ORDER BY STOCK_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทหุ้น</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสประเภทหุ้น</th>
                                <th class="text-center">ชื่อประเภทหุ้น</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['STOCK_TYPE_CODE'];?></td>
                                <td><?php echo $data['STOCK_TYPE_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
    ...
    <script>
    function Export(){
      $("#stock_table").table2excel({
        filename: "stock_type_code"
      });
    }
    </script>
    <!-- footer part start-->
