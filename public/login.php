                        ...
                        <div class="banner_text_iner">
                            ...
                            <form action="save_login.php" method = "post">
                              ...
                              <div class="text-center mt-4">
                                 <?php /* <a href="register.php" title="ลงทะเบียน"><em class="fa fa-user"></em> ลงทะเบียน</a> | */ ?><a href="#ModalForgetPW" rel="modal:open" title="ลืมรหัสผ่าน"> <em class="fa fa-question"></em> ลืมรหัสผ่าน</a>
                              </div>
