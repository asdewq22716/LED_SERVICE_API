	...
	$filterCourt2		 	= "and COURT_CODE = '" . $GET_TO_COURT_CODE . "'"; */
		...
		<div class="content">
						...
						<div class="card">
							<div id="wf_space" class="card-block">
								<form id="frm-input" method="post" action="search_data_process.php">
									...
									if ($_GET["subID"] == 'edit') {
									?>
										<input type="hidden" name="REF_ID" id="REF_ID" value="<?php echo $_REQUEST["ID"]; ?>">
									<?php
									} else {
									?>
										<input type="hidden" name="REF_ID" id="REF_ID" value="<?php echo $_REQUEST["REF_ID"]; ?>">
									...
									<div class="form-group row">
										...
										<div id="CMD_DOC_DATE_BSF_AREA" class="col-md-2 wf-left">
											<label class="input-group">
												<input type="hidden" name="CMD_DOC_DATE" id="CMD_DOC_DATE" value="<?php echo date('d/m') . '/' . (date('Y') + 543)   ?>" class="form-control datepicker" placeholder="">
										...
										<div id="CMD_DOC_TIME_BSF_AREA" class="col-md-2 wf-left">
											<input type="hidden" type="text" name="CMD_DOC_TIME" id="CMD_DOC_TIME" class="form-control" value="<?php echo date("H:i:s"); ?>" readonly="true">
									...
									<div class="form-group row">
										...
										<div id="SEND_TO_BSF_AREA" class="col-md-2 wf-left">
											<?php $sql_SYSTEM = "SELECT CMD_SYSTEM_ID ,SERVICE_SYS_NAME  FROM M_CMD_SYSTEM
																	WHERE 1=1 AND CMD_SYSTEM_ID NOT IN (6) AND CMD_SYSTEM_ID ='" . $GET_SYSTEM_ID . "'
																	ORDER BY SERVICE_SYS_NAME ASC
																	";
											$query_SYSTEM  = db::query($sql_SYSTEM);
											$rec_SYSTEM  = db::fetch_array($query_SYSTEM);
											?>
											<input type="hidden" type="text" name="SYSTEM_ID" id="SYSTEM_ID" value="<?php echo $GET_SYSTEM_ID; ?> ">
											<label class="input-group badge badge-lg bg-info"><?php echo $rec_SYSTEM['SERVICE_SYS_NAME']; ?></label>
										</div>
									...
									<span id="show_form_source_input">
										<div class="form-group row">
											...
											<div id="T_BLACK_CASE_BSF_AREA" class="col-md-2 wf-left">
												<label class="input-group badge badge-lg bg-info"><?php echo $GET_T_NO_BLACK . $GET_TO_BLACK_CASE . "/" . $GET_TO_BLACK_YY; ?></label>
												<input type="hidden" name="T_BLACK_CASE" id="T_BLACK_CASE" class="form-control" value="<?php echo $GET_T_NO_BLACK; ?>" <?php echo $inputReadonly; ?>>
												<input type="hidden" name="BLACK_CASE" id="BLACK_CASE" class="form-control" value="<?php echo $GET_TO_BLACK_CASE; ?>" <?php echo $inputReadonly; ?>>
												<input type="hidden" name="BLACK_YY" id="BLACK_YY" class="form-control" value="<?php echo $GET_TO_BLACK_YY; ?>" <?php echo $inputReadonly; ?>>
											</div>
											...
											<div id="T_RED_CASE_BSF_AREA" class="col-md-2 wf-left">
												<label class="input-group badge badge-lg bg-info"><?php echo $GET_TO_T_RED_CASE . $GET_TO_RED_CASE . "/" . $GET_TO_RED_YY; ?></label>
												<input type="hidden" name="T_RED_CASE" id="T_RED_CASE" class="form-control" value="<?php echo $GET_TO_T_RED_CASE; ?>" <?php echo $inputReadonly; ?>>
												<input type="hidden" name="RED_CASE" id="RED_CASE" class="form-control" value="<?php echo $GET_TO_RED_CASE; ?>" <?php echo $inputReadonly; ?>>
												<input type="hidden" name="RED_YY" id="RED_YY" class="form-control" value="<?php echo $GET_TO_RED_YY; ?>" <?php echo $inputReadonly; ?>>
											</div>
										...
										<div class="form-group row">
											...
											<div id="CASE_TYPE_BSF_AREA" class="col-md-2 wf-left">
												...
												$sqlCourt_SEND = "	SELECT 		COURT_CODE,COURT_NAME
												FROM 		M_COURT 
												WHERE 		1=1 AND COURT_CODE = '" . ($GET_COURT_CODE == "50" ? "050" : $GET_COURT_CODE) . "'
												ORDER BY 	COURT_CODE ASC
												";
												$queryCourt_SEND = db::query($sqlCourt_SEND);
												$recCourt_SEND = db::fetch_array($queryCourt_SEND);
												?>
												<input type="hidden" name="COURT_CODE" id="COURT_CODE" value="<?php echo $recCourt_SEND['COURT_CODE']; ?> ">
												<label class="input-group badge badge-lg bg-info"><?php echo $recCourt_SEND['COURT_NAME']; ?></label>
											</div>
										</div>
										<div class="form-group row">
											...
											<div id="PLAINTIFF_PRE_NAME_AREA" class="col-md-4 wf-left">
												<input type="hidden" name="D_C" id="D_C" class="form-control" value="<?php echo $GET_PLAINTIFF; ?>">
												<label class="input-group badge badge-lg bg-info"><?php echo  $GET_PLAINTIFF; ?></label>
											</div>
										</div>
										<div class="form-group row">
											<div class="col-md-2">
											...
											<div id="DEPT_NAME" class="col-md-4 wf-left">
												<input type="hidden" name="D_NAME" id="D_NAME" class="form-control" value="<?php echo $GET_DEFENDANT; ?>">
												...
												<label class="input-group badge badge-lg bg-info"><?php echo $GET_DEFENDANT; ?></label>
											</div>
										</div>
									</span>
									...
									<span id="hide_form_send_to" style="<?php echo ($rec_cmd["CMD_FIX_DATE_STATUS"] == 'Y') ? "display:none;" : "" ?>">
										...
										<div class="form-group row">
											...
											<div id="SEND_TO_BSF_AREA" class="col-md-2 wf-left">
												<?php
												$sql_receive = "SELECT CMD_SYSTEM_ID ,SERVICE_SYS_NAME FROM M_CMD_SYSTEM
														WHERE 1=1  AND CMD_SYSTEM_ID ='" . $GET_SEND_TO . "'
														ORDER BY SERVICE_SYS_NAME ASC
											  ";
												$query_receive = db::query($sql_receive);
												$rec_receive = db::fetch_array($query_receive);
												?>
												<input type="hidden" name="SEND_TO" id="SEND_TO" value="<?php echo $GET_SEND_TO; ?>">
												<label class="input-group badge badge-lg bg-info"><?php echo $rec_receive['SERVICE_SYS_NAME']; ?></label>
											</div>
										</div>
										...
										<span id="show_form_source_input2">
											...
											<div class="form-group row">
												...
												<div id="T_BLACK_CASE_BSF_AREA" class="col-md-2 wf-left">
													<label class="input-group badge badge-lg bg-info"><?php echo $GET_FORM_PREFIX_BCASE . $GET_FORM_BLACK_CASE . "/" . $GET_FORM_BLACK_YY; ?></label>
													<input type="hidden" name="TO_T_BLACK_CASE" id="TO_T_BLACK_CASE" class="form-control" value="<?php echo $GET_FORM_PREFIX_BCASE; ?>" <?php echo $inputReadonly; ?>>
													<input type="hidden" name="TO_BLACK_CASE" id="TO_BLACK_CASE" class="form-control" value="<?php echo $GET_FORM_BLACK_CASE; ?>" <?php echo $inputReadonly; ?>>
													<input type="hidden" name="TO_BLACK_YY" id="TO_BLACK_YY" class="form-control" value="<?php echo $GET_FORM_BLACK_YY; ?>" <?php echo $inputReadonly; ?>>
												...
												<div id="T_RED_CASE_BSF_AREA" class="col-md-2 wf-left">
													<label class="input-group badge badge-lg bg-info"><?php echo $GET_FORM_PREFIX_RCASE . $GET_FORM_RED_CASE . "/" . $GET_FORM_RED_YY; ?></label>
													<input type="hidden" name="TO_T_RED_CASE" id="TO_T_RED_CASE" class="form-control" value="<?php echo $GET_FORM_PREFIX_RCASE; ?>" <?php echo $inputReadonly; ?>>
													<input type="hidden" name="TO_RED_CASE" id="TO_RED_CASE" class="form-control" value="<?php echo $GET_FORM_RED_CASE; ?>" <?php echo $inputReadonly; ?>>
													<input type="hidden" name="TO_RED_YY" id="TO_RED_YY" class="form-control" value="<?php echo $GET_FORM_RED_YY; ?>" <?php echo $inputReadonly; ?>>
											...
											<div class="form-group row">
												...
												<div id="TO_COURT_NAME_BSF_AREA" class="col-md-5 wf-left">
												  ...
												  ORDER BY COURT_CODE ASC";
													...
													?>
													<input type="hidden" name="TO_COURT_CODE" id="TO_COURT_CODE" value="<?php echo $GET_TO_COURT_CODE; ?>">
													<label class="input-group badge badge-lg bg-info"><?php echo $recCourt['COURT_NAME']; ?></label>
												</div>
										...
										<div id="CASE_TYPE_BSF_AREA" class="col-md-1 wf-left">
											...
											<div class="form-group row">
												...
												<div id="PLAINTIFF_PRE_NAME_AREA" class="col-md-4 wf-left">
													<input type="hidden" name="TO_PLAINTIFF" id="TO_PLAINTIFF" class="form-control" value="<?php echo $TO_PLAINTIFF; ?>" <?php echo $inputReadonly; ?>>
													<label class="input-group badge badge-lg bg-info"><?php echo $TO_PLAINTIFF; ?></label>
												</div>
											</div>
											<div class="form-group row">
												<div class="col-md-2">
												...
												<div id="DEPT_NAME" class="col-md-4 wf-left">
													<input type="hidden" name="TO_DEFENDANT" id="TO_DEFENDANT" class="form-control" value="<?php echo $TO_DEFENDANT; ?>" <?php echo $inputReadonly; ?>>
													<label class="input-group badge badge-lg bg-info"><?php echo $TO_DEFENDANT; ?></label>
												</div>
											</div>
										</span>
													...
													<tbody id="wfs_show_person">
														...
														if ($_GET['proc'] != 'edit') {
															...
															if ($rec_cmd["T_BLACK_CASE"] != "") {
																...
																$filter1 .= " and xx.PREFIX_BLACK_CASE = '" . trim($rec_cmd['T_BLACK_CASE']) . "'	";
															}
															if ($rec_cmd["BLACK_CASE"] != "") {
																$filter .= " and BLACK_CASE = '" . $rec_cmd['BLACK_CASE'] . "'	";
																$filter1 .= " and xx.BLACK_CASE = '" . trim($rec_cmd['BLACK_CASE']) . "'	";
															}
															if ($rec_cmd["BLACK_YY"] != "") {
																$filter .= " and BLACK_YY = '" . $rec_cmd['BLACK_YY'] . "'	";
																$filter1 .= " and xx.BLACK_YY = '" . trim($rec_cmd['BLACK_YY']) . "'	";
															}
															if ($rec_cmd["T_RED_CASE"] != "") {
																$filter .= " and PREFIX_RED_CASE = '" . $rec_cmd['T_RED_CASE'] . "'	";
																$filter1 .= " and xx.PREFIX_RED_CASE = '" . trim($rec_cmd['T_RED_CASE']) . "'	";
															}
															if ($rec_cmd["RED_CASE"] != "") {
																$filter .= " and RED_CASE = '" . $rec_cmd['RED_CASE'] . "'	";
																$filter1 .= " and xx.RED_CASE = '" . trim($rec_cmd['RED_CASE']) . "'	";
															}
															if ($rec_cmd["RED_YY"] != "") {
																$filter .= " and RED_YY = '" . $rec_cmd['RED_YY'] . "'	";
																$filter1 .= " and xx.RED_YY = '" . trim($rec_cmd['RED_YY']) . "'	";
															}

															if (!empty(trim($rec_cmd["COURT_CODE"]))) {

																if (trim($rec_cmd['COURT_CODE']) == '010030' || trim($rec_cmd['COURT_CODE']) == '050') {
																	$filter .= " and (COURT_CODE = '010030'	or COURT_CODE = '050')";
																	$filter1 .= "and xx.COURT_CODE = '" . trim($rec_cmd['COURT_CODE']) . "'	";
																} else {
															...
															if ($rec_cmd["CMD_SYSTEM"] == 1) { //ระบบงานบังคับคดีแพ่ง
																...
																$sql = "	select 		a.WH_PERSON_ID,a.PREFIX_NAME,a.FIRST_NAME,a.LAST_NAME,a.CONCERN_CODE,a.CONCERN_NAME,a.REGISTER_CODE,a.PREFIX_BLACK_CASE,a.BLACK_CASE,a.BLACK_YY,a.PREFIX_RED_CASE,a.RED_CASE,a.RED_YY,a.COURT_NAME,a.COURT_CODE,ADDRESS,TUM_NAME,AMP_NAME,PROV_NAME,ZIP_CODE,'Civil' as SYSTEM_TYPE
																				...
																				";
																$sqlSelectDataPerson =			add_groupby($sql);
																...
																{$filter1}
																	AND xx.WH_PERSON_ID=a.WH_PERSON_ID
																	AND xx.CONCERN_CODE='11')";
															$sqlSelectDataPerson = "	select 		a.WH_PERSON_ID,a.REGISTER_CODE,a.PREFIX_NAME,a.FIRST_NAME,a.LAST_NAME,a.CONCERN_CODE,a.CONCERN_NAME,a.REGISTER_CODE,a.PREFIX_BLACK_CASE,a.BLACK_CASE,a.BLACK_YY,a.PREFIX_RED_CASE,a.RED_CASE,a.RED_YY,a.COURT_NAME,a.COURT_CODE,ADDRESS,TUM_NAME,AMP_NAME,PROV_NAME,ZIP_CODE,'Mediate' as SYSTEM_TYPE
															from 		".Convert::ConvertTable('WH_CIVIL_CASE_PERSON')." a
															where 		1=1 {$filter}{$fill}
															order by 	CONCERN_CODE asc
															"; */
															...
															order by 	CONCERN_CODE asc";
																...
																if ($_GET["REF_ID"] != "") {
																	$sqlSelectDataPerson = "SELECT
																	ID_CARD  AS REGISTER_CODE,PREFIX_NAME,FIRST_NAME ,LAST_NAME ,'' AS CONCERN_CODE,
																'' AS CONCERN_NAME,'' AS PREFIX_BLACK_CASE,'' AS BLACK_CASE,'' AS BLACK_YY,'' AS PREFIX_RED_CASE,
																'' AS RED_CASE,'' AS RED_YY,'' AS COURT_NAME,'' AS COURT_CODE,'' AS ADDRESS,
																'' AS TUM_NAME,'' AS AMP_NAME,'' AS PROV_NAME,'' AS ZIP_CODE,'Backoffice' AS SYSTEM_TYPE
																FROM
																	M_CMD_PERSON
																WHERE
																	CMD_ID = '" . $_GET['REF_ID'] . "'";
																...
																if (1 == 2) {
																	if ($rec_cmd["GET_PER_TYPE"] == 1) { //ล้มละลายตอบกลับbackoffice
																		$filter = "";
																		if ($_GET["REF_ID"] != "") {
															...
															$sqlSelectDataPerson = "SELECT  a.ID_CARD AS REGISTER_CODE ,a.* FROM M_CMD_PERSON a WHERE a.CMD_ID = '" . $REF_ID . "' ";
														}
														//echo $rec_cmd['COURT_CODE'];
														...
														while ($recSelectDataPerson = db::fetch_array($querySelectDataPerson)) {
															...
															$sqlSelectCmdPerson = "SELECT ID_CARD,PERSON_CMD_TYPE,PERSON_CASE_TYPE FROM M_CMD_PERSON WHERE CMD_ID = '" . $REF_ID . "' AND ID_CARD = '" . $recSelectDataPerson["REGISTER_CODE"] . "'";
															$querySelectCmdPerson = db::query($sqlSelectCmdPerson);
															//echo $sqlSelectCmdPerson;
														...
														?>
															<tr>
																...
																<td>
																	<?php
																	$fill = "";
																	if (!empty($GET_SYSTEM_ID) && $_GET['proc'] != 'edit') {
																		if ($GET_SYSTEM_ID == '1') {
																			$fill .= "AND B.CMD_TYPE_CODE ='10201'";
																		} else if ($GET_SYSTEM_ID == '3') {
																			$fill .= "AND B.CMD_TYPE_CODE ='30201'";
																		} else if ($GET_SYSTEM_ID == '4') {
																			$fill .= "AND B.CMD_TYPE_CODE ='40201'";
																		}
																		$fill .= "AND C.CMD_SYSTEM_ID ='" . $GET_SYSTEM_ID . "'";
																	}
																	$sql = "SELECT DISTINCT
																...
																<td style="width: 300px; max-width: 300px;">
																	<?php
																	$fillPerson = "";
																	if ($rec_cmd["CMD_SYSTEM"] != "") {
																		//$fillPerson="and b.CMD_SYSTEM_ID = " . $rec_cmd["CMD_SYSTEM"] . "";
																	}
															...
															ORDER BY 	A.CMD_TYPE_NAME ASC";
																	...
																	$i = 0;
																	?>
																	<select name="CASE_TYPE_PERSON[<?php echo $recSelectDataPerson["REGISTER_CODE"] ?>]" id="CASE_TYPE_PERSON_<?php echo $recSelectDataPerson["REGISTER_CODE"] ?>" class="form-control select2" tabindex="-2" style="width: 300px; max-width: 300px;">
												...
												<div class="col-md-12">
													<table id="wfsflow" class="table table-bordered sorted_table">
														...
														<tbody id="wfs_show_asset">
															...
															function update_asset_civil($ID)
															{
																$sql = "UPDATE M_CMD_ASSET a
																SET a.PROP_STATUS_NAME = (
																  SELECT b.PROP_STATUS_NAME
																  FROM WH_CIVIL_CASE_ASSETS b
																  WHERE a.ASSET_ID = b.ASSET_ID
																	AND a.CFC_CAPTION_GEN = TO_CHAR(b.CFC_CAPTION_GEN)
																)
																WHERE a.CMD_ID = '" . $ID . "'";
																db::query($sql);
															}
																	...
																	<tr>
																		...
																		<td>
																			...
																			<select name="CMD_TYPE[<?php echo $recSelectCmdAsset["ASSET_ID"] ?>]" id="CMD_TYPE_<?php echo $recSelectCmdAsset["ASSET_ID"] ?>" class="form-control select2" tabindex="-1" aria-hidden="true" required onChange="getCaseType('<?php echo $recSelectCmdAsset["ASSET_ID"] ?>')">
																				...
																				if ($recSelectCmdAsset["PROP_STATUS_NAME"] == '') {
																				}

																				if ($GET_SYSTEM_ID == '2') { //1 เเพ่ง 2 ล้มละลาย
																					if (!empty($recSelectCmdAsset["PROP_STATUS_NAME"])) {
																						if ($recSelectCmdAsset["PROP_STATUS_NAME"] == 'ถอนยึด/ถอนอายัด') {
																						} else if ($recSelectCmdAsset["PROP_STATUS_NAME"] == 'ขายได้แล้ว') { //6 8
																							$propFill = "AND B.CMD_TYPE_ID IN (6,8)";
																						} else if ($recSelectCmdAsset["PROP_STATUS_NAME"] == 'ยึด' || $recSelectCmdAsset["PROP_STATUS_NAME"] == 'อยู่ระหว่างจำหน่าย') { //5 6 7 8
																		...
																		<td style="width: 300px; max-width: 300px;">
																			...
																			$fillAsset = "";
																			if ($rec_cmd["CMD_SYSTEM"] != '') {
																				//$fillAsset = "and b.CMD_SYSTEM_ID = " . $rec_cmd["CMD_SYSTEM"] . "";
																			}
																			$sql2 = "	SELECT 		DISTINCT CMD_TYPE_NAME,CMD_TYPE_CODE
																						FROM 		M_SERVICE_CMD A
																						LEFT JOIN 	M_CMD_SYSTEM B ON A.CMD_SYS_ID = B.CMD_SYSTEM_ID
																			...
																			$query2 = db::query($sql2);
																			?>
																			<select onchange="show_action(this.value,'<?php echo $i; ?>')" name="CASE_TYPE[<?php echo $recSelectCmdAsset["ASSET_ID"] ?>]" id="CASE_TYPE_<?php echo $recSelectCmdAsset["ASSET_ID"] ?>" class="form-control select2" tabindex="-2" style="width: 300px; max-width: 300px;">
																				<option value="" disabled selected>เลือกคำสั่ง</option>
																				<?php
																				while ($dataqry = db::fetch_array($query2)) {
																				?>
																					<!-- <option value="<?php echo $dataqry['CMD_TYPE_CODE']; ?>" <?php echo ($dataqry["CMD_TYPE_CODE"] == $recSelectCmdAsset['ASSET_CASE_TYPE']) ? "selected" : ""; ?>><?php echo $dataqry['CMD_TYPE_NAME']; ?></option> -->
																					<option value="<?php echo $dataqry['CMD_TYPE_CODE']; ?>"><?php echo $dataqry['CMD_TYPE_NAME']; ?></option>
																				<?php
																				}
																				?>
																	   ...
																	   LEFT JOIN M_CMD_SYSTEM B ON A.CMD_SYS_ID = B.CMD_SYSTEM_ID
																	   LEFT JOIN M_CMD_TYPE C ON A.CMD_TYPE_ID = C.CMD_TYPE_ID
																	   WHERE A.CMD_TYPE_CODE='" . $recSelectCmdAsset['ASSET_CASE_TYPE'] . "'";
																			$query_CMD_TYPE_CODE = db::query($sql_CMD_TYPE_CODE);
																			$rec_CMD_TYPE_CODE = db::fetch_array($query_CMD_TYPE_CODE);
																			?>
																			<input type='text' readonly name='input_show_action' id="input_show_action_<?php echo $i; ?>" value="<?php echo $rec_CMD_TYPE_CODE['ACTION'] == "" ? "ไม่มีข้อมูล" : $rec_CMD_TYPE_CODE['ACTION']; ?>" class="form-control">
																		</td>
																	</tr>
															<?php
																	$i++;
									...
									<div class="form-group row">
										...
										<div id="CMD_NOTE_BSF_AREA" class="col-md-6 wf-left">
											<textarea class="form-control" name="CMD_NOTE" id="CMD_NOTE" cols="80" rows="10"></textarea>
										</div>
									</div>
													...
													<script type="text/javascript">
														$(document).ready(function() {
															...
															$('.select2').on('select2:select', function(e) {
																...
																var maxWidth = $(this).siblings('.select2-container').width();

																if (selectedOption.text.length > maxWidth) {
			...
			<script type="text/javascript">
				...
				function show_action(CMD_TYPE_CODE, i) {
					$.ajax({
							url: 'search_data_process_A.php',
							type: 'POST',
							data: {
				...
				<?php
				if (($_GET["proc"] == "" || $_GET["proc"] == 'add') && $_GET["REF_ID"] == "") {/* ถ้าเป็น */
				?>
					$(document).ready(function() {
						getCasePersonData(1);
						getCaseAsset(1);
					...
					if ($GET_T_NO_BLACK == $rec_111['T_BLACK_CASE'] && $GET_TO_BLACK_CASE == $rec_111['BLACK_CASE'] && $GET_TO_BLACK_YY == $rec_111['BLACK_YY']) {
						if ($_GET['STATUS'] == 'RETURN') { //ถ้าเป็นตอบกลับให้ดึงคนจากคำสั่ง
						} else {
					?>
							$(document).ready(function() {
								console.log('redy1')
