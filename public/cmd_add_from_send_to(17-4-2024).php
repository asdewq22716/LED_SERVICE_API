...
<body id="bsf_body" class="">
	<div class="wrapper">
		...
		if ($_GET["REF_ID"] != "") {
			...
			//ข้อมูลหลักคดี
			$rec_cmd = $CmdFunc->sqlCmd($_GET["REF_ID"]);
			...
			if ($_GET["proc"] == 'edit') {
				$rec_cmd = $CmdFunc->sqlCmdEdit($_GET['ID']);
				...
				if ($_GET["GET_T_SYSTEM_ID"] == 1) {
					...
					$sql = "SELECT a.PLAINTIFF2 ,a.DEFFENDANT1 FROM WH_REHABILITATION_CASE_DETAIL a
							WHERE 1=1 
							AND a.PREFIX_BLACK_CASE ='" . $_GET['GET_T_PREFIX_CASE_BLACK'] . "'
							AND a.BLACK_CASE ='" . $_GET['GET_T_CASE_BLACK'] . "'
							AND a.BLACK_YY ='" . $_GET['GET_T_CASE_BLACK_YEAR'] . "'
							AND a.PREFIX_RED_CASE ='" . $_GET['GET_T_PREFIX_CASE_RED'] . "'
							AND a.RED_CASE ='" . $_GET['GET_T_CASE_RED'] . "'
							AND a.RED_YY ='" . $_GET['GET_T_CASE_RED_YEAR'] . "'";
					$query = db::query($sql);
					$rec = db::fetch_array($query);
					$TO_PLAINTIFF = $rec['PLAINTIFF2'];
					$TO_DEFENDANT = $rec['DEFFENDANT1'];
				} else if ($_GET["GET_T_SYSTEM_ID"] == 4) { //ฟื้นฟู

					$sql = "SELECT a.PLAINTIFF_FNAME ,a.DEFENDANT_FNAME 
					...
					$query = db::query($sql);
					$rec = db::fetch_array($query);
					$TO_PLAINTIFF = $rec['PLAINTIFF_FNAME'];
					$TO_DEFENDANT = $rec['DEFENDANT_FNAME'];
				}
			}
		}
								...
								<form id="frm-input" method="post" action="search_data_process.php">
									...
									<div class="form-group row">
										...
										<div id="CMD_DOC_DATE_BSF_AREA" class="col-md-2 wf-left">
											<label class="input-group">
												<input <?php echo $inputReadonly; ?> name="CMD_DOC_DATE" id="CMD_DOC_DATE" value="<?php echo date('d/m') . '/' . (date('Y') + 543)   ?>" class="form-control datepicker" placeholder="">
									...
									<div class="form-group row">
										...
										<div id="SEND_TO_BSF_AREA" class="col-md-2 wf-left">
											...
											<select <?php echo $inputReadonly; ?> name="SYSTEM_ID" id="SYSTEM_ID" class="form-control" tabindex="-1" aria-hidden="true" required onChange="showFormPerType();">
								...
								ol-md-1 wf-left show_per_type" style="display:none">
									...
									<span id="show_form_source_input">
										...
										<div class="form-group row">
											...
											<div id="CASE_TYPE_BSF_AREA" class="col-md-5 wf-left">
												<select <?php echo $inputReadonly; ?> name="COURT_CODE" id="COURT_CODE" class="form-control <?php echo ($inputReadonly != "") ? "" : "select2 select2-hidden-accessible" ?>" tabindex="-1" aria-hidden="true" required>
										...
										<div class="form-group row">
											...
											<div id="PLAINTIFF_PRE_NAME_AREA" class="col-md-8 wf-left">
												<input type="text" name="D_C" id="D_C" class="form-control" value="<?php echo $GET_PLAINTIFF; ?>" <?php echo $inputReadonly; ?>>
										...
										<div class="form-group row">
											...
											<div id="DEPT_NAME" class="col-md-8 wf-left">
												<input type="text" name="D_NAME" id="D_NAME" class="form-control" value="<?php echo $GET_DEFENDANT; ?>" <?php echo $inputReadonly; ?>>
									...
									<span id="hide_form_send_to" style="<?php echo ($rec_cmd["CMD_FIX_DATE_STATUS"] == 'Y') ? "display:none;" : "" ?>">
										...
										<div class="form-group row">
											...
											<div id="SEND_TO_BSF_AREA" class="col-md-2 wf-left">
												<select <?php echo $inputReadonly; ?> name="SEND_TO" id="SEND_TO" class="form-control" tabindex="-1" aria-hidden="true" required onChange="showFormPerType2();">
													<option value="" disabled selected>เลือกระบบงาน</option>
													<?php
													$sql = "SELECT
									*
										...
										<span id="show_form_source_input2">
											...
											<div class="form-group row">
												...
												<div id="TO_COURT_NAME_BSF_AREA" class="col-md-5 wf-left">
													<select <?php echo $inputReadonly; ?> name="TO_COURT_CODE" id="TO_COURT_CODE" class="form-control <?php echo ($inputReadonly != "") ? "" : "select2 select2-hidden-accessible" ?>" tabindex="-1" aria-hidden="true" required>
														<option value="" disabled selected>ศาล</option>
														<?php
														$sqlCourt = "SELECT
													...
													<tbody id="wfs_show_person">
														...
														?>
															<tr>
																...
																WHERE 		A.CMD_TYPE_ID = '" . $PERSON_CMD_TYPE . "'AND CMD_STATUS = 1 and b.CMD_SYSTEM_ID = " . $rec_cmd["CMD_SYSTEM"] . "
