			...
			<div class="col-md-12">
				<div class="card">
					<div id="wf_space" class="card-block">
						<form id="frm-input" method="post" action="show_cmd_process.php">
							...
							<div class="form-group row">
								<div class="col-md-12 wf-center ">
									<!--<div class="f-right">
                      <a class="btn btn-primary  active waves-effect waves-light" href="javascript:void(0)" title="" onclick="addRowPerson();">
						...
						<i class="icofont icofont-ui-add"></i> เพิ่มข้อมูล
									...
									<div class="form-group row">
										<div class="col-md-2 wf-center "><strong>ประเภทกลุ่มคำสั่งเจ้าพนักงาน</strong></div>
										<div class="col-md-2 wf-center ">
											<select name="CMD_TYPE_PERSON_ALL" id="CMD_TYPE_PERSON_ALL" class="form-control select2" tabindex="-1" aria-hidden="true" required onChange="getCaseTypePersonAll()">
									...
									A.CMD_GRP_NAME ASC";
										...
										<div class="col-md-2 wf-center "><strong>คำสั่งเจ้าพนักงาน</strong></div>
										<div class="col-md-2 wf-center ">
											<select name="CASE_TYPE_PERSON_ALL" id="CASE_TYPE_PERSON_ALL" class="form-control select2" tabindex="-2">
												<?php
							...
							<div class="form-group row">
								<div class="col-md-12 wf-center ">
									...
									<div class="form-group row">
										<div class="col-md-2 wf-center "><strong>ประเภทกลุ่มคำสั่งเจ้าพนักงาน</strong></div>
										<div class="col-md-2 wf-center ">
											<select name="CMD_TYPE_ASSET_ALL" id="CMD_TYPE_ASSET_ALL" class="form-control select2" tabindex="-1" aria-hidden="true" required onChange="getCaseTypeAssetAll()">
												<option value="" disabled selected>เลือกประเภทกลุ่มคำสั่ง</option>
												<?php $sql = "SELECT DISTINCT
									CMD_GRP_NAME,B.CMD_TYPE_ID
									FROM
									...
									A.CMD_GRP_NAME ASC";
										...
										<div class="col-md-2 wf-center "><strong>คำสั่งเจ้าพนักงาน</strong></div>
										<div class="col-md-2 wf-center ">
											<select name="CASE_TYPE_ASSET_ALL" id="CASE_TYPE_ASSET_ALL" class="form-control select2" tabindex="-2">
												<option value="" disabled selected>เลือกคำสั่ง</option>
											</select>
										</div>
									</div>
			...
			$.ajax({
				...
				success: function(response) {
					...
					if (type == 1) {
						...
						var i = 1;
						var data = JSON.parse(response);
						$.each(data['data'], function(key, data_value) {
							var checkedIdCard = "";
							//alert($('#proc').val());
							...
							var full_name = data_value.PREFIX_NAME + '' + data_value.FIRST_NAME + ' ' + data_value.LAST_NAME;
