...
if(empty($_SESSION['USER_MAIN'])){
    $sql_data = db::query("SELECT SERVICE_MANAGE_ID FROM USER_API_SERVICE WHERE USR_ID = '".$_SESSION['USR_ID']."'");
...
$sql = "SELECT * FROM M_SERVICE_MANAGE WHERE SERVICE_STATUS ='1' {$filter} {$filter2}";
$qry = db::query($sql);
