...
?>
    ...
    $sql = "SELECT * FROM M_VEHICLE_TYPE_MAP ORDER BY VEHICLE_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทยานพาหนะ</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสประเภทยานพาหนะ</th>
                                <th class="text-center">ชื่อประเภทยานพาหนะ</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['VEHICLE_TYPE_CODE'];?></td>
                                <td><?php echo $data['VEHICLE_TYPE_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
    ...
    <script>
    function Export(){
      $("#vehicle_table").table2excel({
        filename: "vehicle_type_code"
      });
    }
    </script>
    <!-- footer part start-->
