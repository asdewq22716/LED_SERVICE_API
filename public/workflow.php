...
$link_back_process =  ($rec_detail["WFD_BTN_BACK_LINK"] != '')? bsf_show_field($W,$WF,$rec_detail["WFD_BTN_BACK_LINK"]):"workflow.php?W=".$W;
				...
				<div class="col-md-12">
                    <div class="wf-right">&nbsp;
						...
						if($rec_detail["WFD_BTN_BACK_STATUS"] == 'Y' AND $step_pre["NUM_STEP"] > 0){?>
							...
							<button type="button" class="btn btn-danger active waves-effect waves-light" onClick="wf_step_back('<?php echo $W;?>','<?php echo $WFR;?>');"><i class="icofont icofont-arrow-left" <?php if($rec_detail["WFD_BTN_BACK_RESIZE"] == 'Y'){ echo 'data-toggle="tooltip"';}?> title="<?php if($rec_detail["WFD_BTN_BACK_RESIZE"] == 'Y'){ echo $WF_TEXT_DETAIL_PROCESS_BACK;}?>" ></i> <?php if($rec_detail["WFD_BTN_BACK_RESIZE"] != 'Y'){echo $WF_TEXT_DETAIL_PROCESS_BACK;}?></button>&nbsp;
					<?php } 
						if($rec_detail["WFD_BTN_TEMP_STATUS"] == 'Y'){?> 
							<button type="button" class="btn btn-warning waves-effect waves-light" onClick="$('#SAVE_STEP').val('Y');<?php if($rec_detail["WFD_BTN_TEMP_LINK"] != ''){?>$('#form_wf').attr('action','<?php echo bsf_show_field($W,$WF,$rec_detail["WFD_BTN_TEMP_LINK"]);?>');<?php } ?>$('#form_wf').submit();" <?php if($rec_detail["WFD_BTN_TEMP_RESIZE"] == 'Y'){ echo 'data-toggle="tooltip"';}?> title="<?php if($rec_detail["WFD_BTN_TEMP_RESIZE"] == 'Y'){ echo $WF_TEXT_DETAIL_SAVE_TEMP;}?>"><i class="icofont icofont-diskette"></i> <?php if($rec_detail["WFD_BTN_TEMP_RESIZE"] != 'Y'){ echo $WF_TEXT_DETAIL_SAVE_TEMP;}?></button>&nbsp;
						<?php
						}*/
						...
						<input type="hidden" name="wfp" value="<?php echo conText($_GET['wfp']); ?>">
