						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card">
									...
									'<?php echo ($IDCARD) ?>','<?php echo WH_ID_CONVERT_TO_CODE_API($rec_PCC['WH_ID'], $rec_PCC['SYSTEM_TYPE']); ?>');"><?php echo $rec_PCC['PREFIX_BLACK_CASE'] . $rec_PCC['BLACK_CASE'] . $A . $rec_PCC['BLACK_YY']; ?></a></td>
																	<td><a href="" onclick="show_detial_2(
									'<?php echo $rec_PCC['SYSTEM_TYPE'] ?>',
									'<?php echo ($IDCARD) ?>','<?php echo WH_ID_CONVERT_TO_CODE_API($rec_PCC['WH_ID'], $rec_PCC['SYSTEM_TYPE']); ?>');"><?php echo $rec_PCC['PREFIX_RED_CASE'] . $rec_PCC['RED_CASE'] . $B . $rec_PCC['RED_YY']; ?></a></td>
									...
									'<?php echo $rec_PCC['SYSTEM_TYPE'] ?>',
									'<?php echo ($IDCARD) ?>','<?php echo WH_ID_CONVERT_TO_CODE_API($rec_PCC['WH_ID'], $rec_PCC['SYSTEM_TYPE']); ?>');" class="btn btn-info btn-mini"> <i class="icofont icofont-search"></i></button>
																			</div>
																		</nobr>
																	</td>
																</div>
																	...
																	?>
																			<tr>
																				<div>
																					...
																					?>
																					<td><?php echo $AH1['PREFIX_BLACK_CASE'] . $AH1['BLACK_CASE'] . $A . $AH1['BLACK_YY']; ?></td>
																					<td><?php echo $AH1['PREFIX_RED_CASE'] . $AH1['RED_CASE'] . $B . $AH1['RED_YY']; ?></td>
