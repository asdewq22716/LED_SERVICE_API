...
?>
    ...
    $sql = "SELECT * FROM M_DOSS_MAP ORDER BY DOSS_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>สำนวน</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสสำนวน</th>
                                <th class="text-center">ชื่อสำนวน</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['DOSS_CODE'];?></td>
                                <td><?php echo $data['DOSS_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="idiom_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัสสำนวน</th>
                              <th class="text-center">ชื่อสำนวน</th>
