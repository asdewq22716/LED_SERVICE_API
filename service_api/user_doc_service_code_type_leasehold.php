...
?>
    ...
    $sql = "SELECT * FROM M_RENT_TYPE_MAP ORDER BY RENT_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทสิทธิการเช่า</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสประเภทสิทธิการเช่า</th>
                                <th class="text-center">ชื่อประเภทสิทธิการเช่า</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['RENT_TYPE_CODE'];?></td>
                                <td><?php echo $data['RENT_TYPE_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="leasehold_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัสประเภทสิทธิการเช่า</th>
                              <th class="text-center">ชื่อประเภทสิทธิการเช่า</th>
    ...
    <script>
    function Export(){
      $("#leasehold_table").table2excel({
        filename: "leasehold_type_code"
      });
    }
    </script>
    <!-- footer part start-->
