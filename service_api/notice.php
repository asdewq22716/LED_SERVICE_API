<?php include 'comtop.php';
 include 'include/comtop_user.php';?>
    ...
    $sql = "SELECT A.*,B.COURT_NAME_LAW,C.*,D.FILE_NAME,D.FILE_SAVE_NAME FROM M_ANC_NOTICE_WEBSITE A LEFT JOIN M_COURT_CODE_MAP B ON A.COURT_ID = B.COURT_ID LEFT JOIN FRM_ANC_NOTICE C ON A.ANC_NOTICE_WEB_ID = C.WFR_ID LEFT JOIN WF_FILE D ON C.WFR_ID = D.WFR_ID AND D. WFS_FIELD_NAME = 'ANC_NOTICE_FILE' WHERE 1=1 {$filter}";
    $qry = db::query($sql);
