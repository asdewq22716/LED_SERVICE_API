...
?>
    ...
    $sql = "SELECT * FROM M_MAP_PER_TYPE ORDER BY PERSON_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทบุคคล</h4></div>
                    <div class="col-md-6">
                          ...
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['PERSON_TYPE_CODE'];?></td>
                                <td><?php echo $data['PERSON_TYPE_NAME'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="type_person_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัส</th>
                              <th class="text-center">ประเภท</th>
    ...
    <script>
    function Export(){
      $("#type_person_table").table2excel({
        filename: "person_type_code"
      });
    }
    </script>
    <!-- footer part start-->
