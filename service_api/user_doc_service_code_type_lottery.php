...
?>
    ...
    $sql = "SELECT * FROM M_SAVE_TYPE_MAP ORDER BY SAVE_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ประเภทสลากออมทรัพย์</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสประเภทสลากออมทรัพย์</th>
                                <th class="text-center">ชื่อประเภทสลากออมทรัพย์</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['SAVE_TYPE_CODE'];?></td>
                                <td><?php echo $data['SAVE_TYPE_NAME_BR'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="lottery_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัสประเภทสลากออมทรัพย์</th>
                              <th class="text-center">ชื่อประเภทสลากออมทรัพย์</th>
    ...
    <script>
    function Export(){
      $("#lottery_table").table2excel({
        filename: "savings_bank_lottery_type_code"
      });
    }
    </script>
    <!-- footer part start-->
