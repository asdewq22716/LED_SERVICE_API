...
?>
    ...
    $sql = "SELECT * FROM M_LAND_TYPE_MAP ORDER BY LAND_TYPE_CODE ASC";
    $qry = db::query($sql);
    	...
    	<div class="container">
      		<div class="row">
                ...
                <div class="col-md-8">
                  ...
                  <div class="row">
                    <div class="col-md-6"><h4>ชนิดเอกสารสิทธิ์</h4></div>
                    <div class="col-md-6">
                    ...
                    <table class="table">
                        <thead class="breadcrumb_bg">
                            <tr>
                                ...
                                <th class="text-center">รหัสชนิดเอกสารสิทธิ์</th>
                                <th class="text-center">ชื่อชนิดเอกสารสิทธิ์</th>
                            </tr>
                        </thead>
                        <tbody>
                          <?php if($total > 0){
                            ...
                            while ($data = db::fetch_array($data_main)) {?>
                              <tr>
                                ...
                                <td class="text-center"><?php echo $data['LAND_TYPE_CODE'];?></td>
                                <td><?php echo $data['LAND_TYPE_NAME_LAW'];?></td>
                              </tr>
                            <?php
                            $i++;
                          }
                  ...
                  <table class="table" id="license_table">
                      <thead class="breadcrumb_bg">
                          <tr>
                              <th class="text-center">รหัสชนิดเอกสารสิทธิ์</th>
                              <th class="text-center">ชื่อชนิดเอกสารสิทธิ์</th>
    ...
    <script>
    function Export(){
      $("#license_table").table2excel({
        filename: "license_code"
      });
    }
    </script>
    <!-- footer part start-->
