      ...
      <aside class="main-sidebar hidden-print " >
        ...
        <!-- Sidebar Menu-->
          <ul class="sidebar-menu">
            ...
            <li><a href="widget.html"><i class="icon-grid"></i><span> Widget</span><span class="label label-warning menu-caption">33+</span></a> </li>
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i>
              ...
              <ul class="treeview-menu">
                <li><a class="waves-effect waves-dark" href="../verticle/menu-static.html" target="_blank"><i class="icon-arrow-right"></i> Static Layout</a></li>
                <li><a class="waves-effect waves-dark" href="../verticle/menu-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header and Sidebar Fixed</a></li>
                <li><a class="waves-effect waves-dark" href="../verticle/menu-header-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Header Fixed</a></li>
                ...
                <li><a class="waves-effect waves-dark" href="../verticle/menu-footer-fixed.html" target="_blank"><i class="icon-arrow-right"></i> Footer Fixed</a></li>
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Charts &amp; Maps</span><span class="label label-success menu-arrow-caption">New</span><i class="icon-arrow-down"></i></a>
                <ul class="treeview-menu">
