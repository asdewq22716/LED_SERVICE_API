...
<div class="content-wrapper">
	...
	<div class="container-fluid">
			...
			<div class="col-sm-12">
				<div class="main-header">
					...
					<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo $txt_link_back ?>"><?php echo $txt_system_sub ?></a>
						</li>
						<li class="breadcrumb-item">
					...
					<div class="f-right">
						<a class="btn btn-danger waves-effect waves-light" href="<?php echo $txt_link_back ?>" role="button">
		...
		<!-- Row end -->
		<form action="workflow_function.php" method="post" enctype="multipart/form-data" id="form_wf">
				...
				<div class="form-group row" id="DIV_WF_MAIN_WH" style="display:<?php echo $display;?>">
					...
					<div class="col-md-5">
						...
						<div class="input-group">
							...
							<input type="text" name="WF_MAIN_SHORTNAME" id="WF_MAIN_SHORTNAME" class="form-control text-uppercase" placeholder="TABLE NAME"  autocomplete="off" maxlength="22" <?php
...
<div class="row">
				<div class="col-md-12">
					<div class="f-left">
						<button type="button" class="btn btn-md btn-danger active waves-effect waves-light" onclick="window.location.href='<?php echo $txt_link_back ?>'">
							<i class="typcn typcn-chevron-left-outline"></i> ย้อนกลับ
						</button>
					</div>
					<div class="wf-right">&nbsp;
