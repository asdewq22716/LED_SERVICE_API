...
?> 
			<form action="workflow_detail_function_m.php" method="post" enctype="multipart/form-data" id="form_wf" target="TARGET_ADD" autocomplete="off">
					...
					<div class="card-block tab-icon">
						 <!-- Nav tabs -->
							<ul class="nav nav-tabs md-tabs " role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" data-toggle="tab" href="#tabtrow" role="tab"><i class="typcn typcn-export"></i>การโยนค่าไปกระบวนการอื่น</a>
									<div class="slide"></div>
								</li>
                    ...
                    <div class="card_bk">
                        ...
                        <div class="card-block">
							<div class="form-group row">
								<div class="col-md-4">
									<div class="checkbox-color checkbox-primary">
										<input name="WFD_EMAIL_SETTING" id="WFD_EMAIL_SETTING" type="checkbox" value="Y" <?php echo $rec_detail['WFD_EMAIL_SETTING'] == "Y" ? 'checked' : ''; ?>>
								...
								<div class="col-md-4">
									<div class="checkbox-color checkbox-primary">
										<input name="WFD_EMAIL_SETTING_EDIT" id="WFD_EMAIL_SETTING_EDIT" type="checkbox" value="Y" <?php echo $rec_detail['WFD_EMAIL_SETTING_EDIT'] == "Y" ? 'checked' : ''; ?>>
								...
								<div class="form-group row">
								  <div class="col-md-7">
									  <label for="WFD_DETAIL_EMAIL_CAL" class="form-control-label wf-right">กำหนด Field วันที่ กรณีลง Calendar<span class="text-danger"></span></label>
								  </div>
								  <div class="col-md-5">
									  <input type="text" class="form-control" name="WFD_DETAIL_EMAIL_CAL" id="WFD_DETAIL_EMAIL_CAL" value="<?php echo $rec_detail['WFD_DETAIL_EMAIL_CAL']; ?>">
								  </div>
								  </div>
								</div>-->
							</div>
							...
							<!---->
							<div class="form-group">
								  <textarea name="WFD_DETAIL_EMAIL" id="WFD_DETAIL_EMAIL" class="form-control" rows="5"><?php echo nl2br($rec_detail['WFD_DETAIL_EMAIL']); ?></textarea>
								  <small class="form-text text-muted">ตัวแปร Table Field ให้ใช้ ##FIELD!!</small>
							</div>
							<!---->
							<div class="form-group row">
							...
							<!---->
							<div class="form-group">
								  <textarea name="WFD_DETAIL_EMAIL_DESC" id="WFD_DETAIL_EMAIL_DESC" class="form-control" rows="5"><?php echo nl2br($rec_detail['WFD_DETAIL_EMAIL_DESC']); ?></textarea>
								  <small class="form-text text-muted">ตัวแปร Table Field ให้ใช้ ##FIELD!!</small>
							</div>
							<!---->	
							...
							<div class="form-group">
								<div class="form-radio">
								  <div class="radio"> <!-- radio-inline -->
										<label>
											<input type="radio" name="WFD_EMAIL_SEND_SETTING" id="WFD_EMAIL_SEND_SETTING" value="" onclick="if(this.checked === true){$('#CONFIG_EMAIL_SEND_SETTING_FILED').hide();}" <?php if($rec_detail['WFD_EMAIL_SEND_SETTING'] == ''){ echo 'checked';}?>> <!--onclick="show_type(this.value);" -->
												<i class="helper"></i> ส่งตามสิทธิ์ของขั้นตอน
										</label>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="WFD_EMAIL_SEND_SETTING" id="WFD_EMAIL_SEND_SETTING" value="S" onclick="if(this.checked === true){$('#CONFIG_EMAIL_SEND_SETTING_FILED').show();}" <?php if($rec_detail['WFD_EMAIL_SEND_SETTING'] == 'S'){ echo 'checked';}?>><i class="helper">
							...
							<!---->	
							<div id="CONFIG_EMAIL_SEND_SETTING_FILED" <?php if($rec_detail['WFD_EMAIL_SEND_SETTING'] == ''){ echo 'style="display:none;"';}?>>
							<div class="form-group row">
								<div class="col-md-2">
									<label for="WFD_EMAIL_SETTING_FIELD" class="form-control-label">ระบุ field email</label>
								</div>
								<div class="col-md-4">
									<input type="text" class="form-control" name="WFD_EMAIL_SETTING_FIELD" id="WFD_EMAIL_SETTING_FIELD" value="<?php echo $rec_detail['WFD_EMAIL_SETTING_FIELD']; ?>">
								</div>
							</div>
							<!---->	
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-4">
									 <input type="text" class="form-control" name="WFD_DETAIL_EMAIL_CAL_STIME" id="WFD_DETAIL_EMAIL_CAL_STIME" value="<?php echo $rec_detail['WFD_DETAIL_EMAIL_CAL_STIME']; ?>">
								</div>
							</div>
							<!---->
							<div class="form-group row">
								...
								<div class="col-md-4">
									 <input type="text" class="form-control" name="WFD_DETAIL_EMAIL_CAL_EDATE" id="WFD_DETAIL_EMAIL_CAL_EDATE" value="<?php echo $rec_detail['WFD_DETAIL_EMAIL_CAL_EDATE']; ?>">
								</div>
								<div class="col-md-2">
									<label for="WFD_DETAIL_EMAIL_CAL_ETIME" class="form-control-label">Field เวลาสิ้นสุด</label>
								</div>
								<div class="col-md-4">
									 <input type="text" class="form-control" name="WFD_DETAIL_EMAIL_CAL_ETIME" id="WFD_DETAIL_EMAIL_CAL_ETIME" value="<?php echo $rec_detail['WFD_DETAIL_EMAIL_CAL_ETIME']; ?>">
								</div>
							</div>
							<!---->
							<div class="form-group row">
								...
								<div class="col-md-10">
									 <input type="text" class="form-control" name="WFD_DETAIL_EMAIL_CAL_PLACE" id="WFD_DETAIL_EMAIL_CAL_PLACE" value="<?php echo $rec_detail['WFD_DETAIL_EMAIL_CAL_PLACE']; ?>">
									  <small class="form-text text-muted">ตัวแปร Table Field ให้ใช้ ##FIELD!!</small>
								</div>
							</div>
							<!---->
...
<iframe name="TARGET_ADD" id="TARGET_ADD"></iframe>
</div>
