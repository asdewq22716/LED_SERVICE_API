...
if($WF_TYPE == 'W'){
	$url_back = "workflow_group_list.php";
	
}elseif($WF_TYPE == 'F'){
	$url_back = "form_group_list.php";

}elseif($WF_TYPE == 'M'){
	$url_back = "master_group_list.php";
	
}elseif($WF_TYPE == 'R'){
	$url_back = "report_group_list.php";
}elseif($WF_TYPE == 'MN'){
...
$GROUP_ICON = conText($_REQUEST['GROUP_ICON']);
