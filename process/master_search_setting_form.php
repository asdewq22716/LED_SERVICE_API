...
{
	$p_process = "เพิ่ม";
	$mx = db::get_max("MASTER_CONFIG", "FORM_QT_ID") + 1;
}
elseif($process == "edit")
{
	
	$q_edit = db::query("select * from MASTER_CONFIG where FORM_QT_ID = '".$id."'");
	...
	<div class="container-fluid">
			...
			<div class="col-sm-12">
				<div class="main-header">
					...
					<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
						...
						<li class="breadcrumb-item"><a href="<?php echo $p_url; ?>.php?W=<?php echo $R["MM_ID"];?>"><?php echo $p_name; ?> <?php echo $R['WF_MAIN_NAME']; ?></a></li>
						<li class="breadcrumb-item">
							<a href="#"><?php echo $p_process; ?>ข้อมูล</a>
						</li>
					</ol>
					<div class="f-right">
						<a class="btn btn-danger waves-effect waves-light" href="<?php echo $p_url; ?>.php?W=<?php echo $R["MM_ID"];?>" role="button">
		...
		<form action="<?php echo $p_url; ?>_function.php" name="form_wf" id="form_wf" method="post" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="f-left">
						<button type="button" class="btn btn-md btn-danger active waves-effect waves-light" onclick="window.location.href='<?php echo $p_url; ?>.php?W=<?php echo $R["MM_ID"];?>';">
							<i class="typcn typcn-chevron-left-outline"></i> ย้อนกลับ
						</button>
					</div>
					<div class="wf-right">&nbsp;
