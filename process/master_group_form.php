...
$sql = db::query("select * from MASTER_GROUP where GROUP_ID = '".$id."'");
...
{
	$p_process = "เพิ่ม";
	$mx = db::get_max("MASTER_GROUP", "GROUP_ORDER") + 1;
}
elseif($process == "edit")
{
	$p_process = "แก้ไข";
...
<div class="content-wrapper">
	...
	<div class="container-fluid">
		...
		<!-- Row end -->
		<form action="<?php echo $p_url; ?>_function.php" name="form_group" id="form_group" method="post" enctype="multipart/form-data">
