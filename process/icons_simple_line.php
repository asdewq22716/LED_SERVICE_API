...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="main-header">
                        ...
                        <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                            ...
                            <li class="breadcrumb-item">Simple line Icons
                            </li>
                        </ol>
						<div class="f-right">
            ...
            <!--Simple Line Icon Section Start  -->
            <!-- Row Starts -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header"><h5 class="card-header-text">Simple line icon</h5></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Name
                                    <input class="form-control" type="text" name="" id="name" value="fa fa-wpbeginner">
                                </div>
                                <div class="form-group">
                                    Code
                                    <input class="form-control" type="text" id="code" name="" value='<i class="fa fa-wpbeginner"></i>'>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- custom js -->
<script src="../assets/pages/simple-line-icons.js"></script>
