...
$sql = db::query("select * from USR_GROUP where GROUP_ID = '".$id."'");
...
{
	$p_process = "เพิ่ม";
	$mx = db::get_max("USR_GROUP", "GROUP_ORDER") + 1;
}
elseif($process == "edit")
{
	$p_process = "แก้ไข";
				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-block">
							...
							<div class="form-group row">
								<div class="col-md-2">
									<label for="GROUP_CODE" class="form-control-label wf-right">รหัส<?php echo $p_name; ?></label>
								</div>
								<div class="col-md-4">
									<input type="text" id="GROUP_CODE" name="GROUP_CODE" placeholder="ตั้งรหัส <?php echo $p_name; ?>" class="form-control" value="<?php echo $rec['GROUP_CODE']; ?>">
								</div>
								<div class="col-md-2">
