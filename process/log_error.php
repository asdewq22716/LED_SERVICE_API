			...
			<div class="col-sm-8">
				<div class="main-header">
					...
					<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
						...
						<li class="breadcrumb-item">
							<a href="<?php echo $p_url; ?>_list.php">Log Error</a>
						</li>
					</ol>
				</div>
			</div>
				...
				<div class="card">
					<div class="card-header">
						<h5 class="card-header-text">
							<i class="icofont icofont-ui-folder"></i> Log Error
						</h5>
					</div>
							...
							<table cellspacing="0" id="tech-companies-1" class="table table-bordered sorted_table">
								...
								<tbody>
											...
											while(false !== ($file = readdir($dh)))
											{
												...
												{?>
													<tr>
														...
														<td><a href="<?php echo $dir.$file;?>" target="_blank"><?php echo $file;?></a></td>
													</tr>
													<?php
												}
												$i++;
									...
									{?>
										<tr>
											<td class="text-center"><?php echo $i;?></td>
											<td><a href="javascript:void(0);" onclick="show_log('<?php echo $dir.$_val;?>', 'Log Error')"><?php echo $_val;?></a></td>
										</tr>
										<?php
										$i++; }
									?>
