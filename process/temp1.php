						...
						<div class="weather-bg p-40">
							<div class="svg-cloud">
								...
								<div class="cloud-temp"> 
									<h1 class="display-2">Workflow Management</h1>
								</div>
							</div>
						</div>
						<div class="f-left">
							<div class="breadcrumb-icon-block" >
								<ul id="breadcrumb-triangle">
									<li><a href="home.php"><span class="icofont icofont-home"> </span></a></li>
									<li><a href="#"><span class="icofont icofont-chart-flow-alt-2"> </span> All Workflow</a></li>
								</ul>
							</div>
						 </div>
						 <div class="f-right">
							<div class="breadcrumb-icon-block" >
								<a href="#" class="btn btn-md btn-success active waves-effect waves-light"><i class="ion-android-add"></i> New Workflow</a>
							</div>
						 </div>
					</div>
				</div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">
								<i class="icofont icofont-ui-folder"></i> Project Work
                            </h5>
                        </div> 
