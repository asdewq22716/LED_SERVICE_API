...
<div id="sample">
  <div style="width: 100%; display: flex; justify-content: space-between">
	...
	<br /><br /><br /><br />
							...
							<div class="form-group row">
								<div class="col-md-12"> 
										<label for="WF_MAIN_NAME" class="form-control-label">Workflow Name <span class="text-danger">*</span></label>
							...
							<div class="form-group row">
								<div class="col-md-12"> 
										...
										<input type="hidden" name="WF_ALIAS" id="WF_ALIAS" value="WFR_">
										<div class="input-group">
										<span class="input-group-addon">WFR_</span>
							...
							<div class="form-group row">
								<div class="col-md-12"> 
										...
										<select name="WF_GROUP_ID" id="WF_GROUP_ID" class="form-control select2" required aria-required="true" placeholder="เลือก...">
											<option value=""></option>
											<?php
											$sql_group = db::query("select GROUP_NAME , GROUP_ID from WF_GROUP WHERE WF_TYPE = 'W' order by GROUP_ORDER asc");
