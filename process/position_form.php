...
$sql = db::query("select * from USR_POSITION where POS_ID = '".$id."'");
...
{
	$p_process = "เพิ่ม";
	$mx = db::get_max("USR_POSITION", "POS_ORDER") + 1;
}
elseif($process == "edit")
{
	$p_process = "แก้ไข";
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header"><h5 class="card-header-text">
							...
							<div class="f-right">
								<label for="POS_STATUS" class="custom-control custom-checkbox">
									<input type="checkbox" name="POS_STATUS" id="POS_STATUS" class="custom-control-input" value="Y" <?php echo $rec['POS_STATUS'] == "Y" ? 'checked' :''; ?>>
						...
						<div class="card-block">
							...
							<div class="form-group row">
								<div class="col-md-2">
									<label for="POS_ORDER" class="form-control-label wf-right">ลำดับ
										<span class="text-danger">*</span></label>
								</div>
								<div class="col-md-1">
									<input type="text" id="POS_ORDER" name="POS_ORDER" placeholder="ลำดับ" class="form-control" value="<?php echo $mx; ?>" required>
								</div>
								<div class="col-md-2 offset-md-3">
									<label for="POS_CODE" class="form-control-label wf-right">รหัส<?php echo $p_name; ?></label>
								</div>
								<div class="col-md-4">
									<input type="text" id="POS_CODE" name="POS_CODE" placeholder="ตั้งรหัส <?php echo $p_name; ?>" class="form-control" value="<?php echo $rec['POS_CODE']; ?>">
								</div>
							</div>
							<!---->
							<div class="form-group row">
								<div class="col-md-2">
									<label for="POS_NAME" class="form-control-label wf-right">ชื่อ<?php echo $p_name; ?>
										<span class="text-danger">*</span></label>
								</div>
								<div class="col-md-4">
									<input type="text" id="POS_NAME" name="POS_NAME" placeholder="ตั้งชื่อ <?php echo $p_name; ?>" class="form-control" value="<?php echo $rec['POS_NAME']; ?>" required>
								</div>
								<div class="col-md-2">
									<label for="POS_SHORT_NAME" class="form-control-label wf-right">ชื่อย่อ<?php echo $p_name; ?></label>
								</div>
								<div class="col-md-4">
									<input type="text" id="POS_SHORT_NAME" name="POS_SHORT_NAME" placeholder="ตั้งชื่อย่อ <?php echo $p_name; ?>" class="form-control" value="<?php echo $rec['POS_SHORT_NAME']; ?>">
								</div>
							</div>
						</div>
					</div>
