...
$p_name_main = 'บริหาร Module';
$p_name = 'เลือกข้อมูลที่อยู่ใน module';
$p_url = 'menu_group_function.php';
$M_ID = conText($_GET['M_ID']);
$process = conText($_GET['process']);

$sql_menu = db::query("select M_NAME from WF_MODULE WHERE M_ID='".$M_ID."'");
			...
			<div class="col-sm-8">
				<div class="main-header">
					...
					<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
						...
						<li class="breadcrumb-item"><a href="module_list.php"><?php echo $p_name_main;?></a></li>
					...
					<div class="card">
						<div class="card-header">
							<h5 class="card-header-text">
								<i class="icofont icofont-ui-folder"></i> <?php echo $p_name.$menu["M_NAME"]; ?>
							</h5>
						...
						<div class="card-block">
							...
							<?php 
								...
								while($rec_w = db::fetch_array($sql_w)){
									$sql_d = db::query("SELECT * FROM WF_MODULE_DETAIL WHERE WF_MAIN_ID = '".$rec_w['WF_MAIN_ID']."' AND M_ID = '".$M_ID."'");
									$m_d = db::fetch_array($sql_d);
									?>
									<div class="form-group row">
									  <div class="col-md-3"></div>
									  <div class="col-md-9">		
										<label for="WF_SELECT<?php echo $i;?>" class="custom-control custom-checkbox">
											<input type="checkbox" name="WF_SELECT[]" id="WF_SELECT<?php echo $i;?>" class="custom-control-input" value="<?php echo $rec_w["WF_MAIN_ID"];?>" <?php echo ($m_d["WF_MAIN_ID"] == $rec_w["WF_MAIN_ID"])?'checked':''?>>
											<span class="custom-control-indicator"></span>
