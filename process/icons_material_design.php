...
<!-- Sidebar chat end-->
    <div class="content-wrapper">
            ...
            <div class="col-sm-12">
                <div class="main-header">
                    ...
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item">Material-Design-Icons
                        </li>
                    </ol>
					<div class="f-right">
        ...
        <!-- Row end -->
            <!-- Material Design Icons start  -->
            <!-- Row start -->
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                     <div class="card-header"><h5 class="card-header-text"> New Icons </h5></div>
                      <div class="card-block">
                          <div class="data_table_main icon-list-demo">
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-3 col-xs-12 m-b-10">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                       <div class="card-header"><h5 class="card-header-text">Web Application</h5></div>
                        <div class="card-block">
                            <div class="data_table_main icon-list-demo">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                     <div class="card-header"><h5 class="card-header-text">Notifications</h5></div>
                      <div class="card-block">
                          <div class="data_table_main icon-list-demo">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                       <div class="card-header"><h5 class="card-header-text">Person
                        </h5>
                           </div>
                        <div class="card-block">
                            <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header">
                       <h5 class="card-header-text">File </h5>
                   </div>
                    <div class="card-block">
                        <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Editor
                    </h5>
                    </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Comment </h5>  </div>
                    <div class="card-block">
                        <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Hardware
                    </h5>
                   </div>
                    <div class="card-block">
                        <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Directional
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Map (aliases)
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">View
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Date / Time
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Social
                    </h5>
                    </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Image
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Audio / Video
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="co-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Numbers
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
            ...
            <div class="col-sm-12">
                <div class="card">
                   <div class="card-header"><h5 class="card-header-text">Other
                    </h5>
                       </div>
                    <div class="card-block">
                    <div class="data_table_main icon-list-demo">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4 class="modal-title" id="myModalLabel">Material Design Icons</h4>
  </div>
...
<!-- custom js -->
<script src="../assets/pages/material-icon.js"></script>
