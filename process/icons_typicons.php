                ...
                <div class="col-sm-12">
                    <div class="main-header">
                        ...
                        <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                            ...
                            <li class="breadcrumb-item">Typicons-icons
                            </li>
                        </ol>
						<div class="f-right">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Typicons Icons</h4>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Name
                                    <input class="form-control" type="text" name="wpbeginner" id="name" value="fa fa-wpbeginner">
                                </div>
                                <div class="form-group">
                                    Code
                                    <input class="form-control" type="text" id="code" name="wpbeginnerr" value='<i class="fa fa-wpbeginner"></i>'>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- custom js -->
<script src="../assets/pages/typicon.js"></script>
</body>
</html>
