...
$p_name = "ตั้งค่าภาษา (Multi-Languages)";
$p_url = "system_language";
$sql = db::query("select * from WF_LANGUAGE ORDER BY LANG_ORDER ASC");
		...
		<div class="container-fluid">
			...
			<div class="row" id="animationSandbox">
				<div class="col-sm-8">
					<div class="main-header">
						...
						<ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
							...
							<li class="breadcrumb-item">
								<a href="<?php echo $p_url; ?>_list.php"><?php echo $p_name; ?></a>
							</li>
						</ol>
					</div>
				</div>
				<div class="col-sm-4">
					...
					<div class="f-right">
						<a class="btn btn-primary waves-effect waves-light" href="<?php echo $p_url; ?>_form.php?process=add&WF_TYPE=<?php echo $WF_TYPE;?>" role="button">
									...
									<table cellspacing="0" id="tech-companies-1" class="table table-bordered sorted_table">
										<thead>
											<tr class="bg-primary">
												...
												<th style="width: 60%;" class="text-center" data-priority="1">ชื่อภาษา</th>
										...
										<tbody>
											...
											<tr class="wf_keyword-box">
												<td class="text-center move-td">
													<input type="number" id="LANG_ORDER<?php echo $i; ?>" name="LANG_ORDER<?php echo $i; ?>" value="<?php echo $rec['LANG_ORDER']; ?>" class="form-control input-success text-right" style="width:80px;">
												</td>
												<th class="text-center">
													<div class="rkmd-checkbox checkbox-rotate checkbox-ripple">
														<label class="input-checkbox checkbox-success">
															<input type="checkbox" name="LANG_STATUS<?php echo $i; ?>" id="LANG_STATUS<?php echo $i; ?>" <?php echo $rec['LANG_STATUS'] == "Y" ? 'checked' :''; ?> value="Y">
															<span class="checkbox"></span>
														</label>
														<div class="captions"></div>
													</div>
													<input type="hidden" name="id<?php echo $i; ?>" id="id<?php echo $i; ?>" value="<?php echo $rec['LANG_ID']; ?>">
												</th>
												<th class="wf_keyword">
													<?php echo $rec['LANG_NAME']; ?>
												</th>
												<td class="text-center">
													<nobr>
														<button type="button" class="btn btn-warning btn-icon" data-toggle="tooltip" data-placement="top" title="แก้ไข <?php echo $p_name; ?>" onclick="window.location.href='<?php echo $p_url; ?>_form.php?process=edit&G=<?php echo $rec['LANG_ID']; ?>&WF_TYPE=<?php echo $WF_TYPE; ?>';">
															<i class="icofont icofont-edit-alt"></i>
														</button> &nbsp;
														<button type="button" class="btn btn-danger btn-icon" data-toggle="tooltip" data-placement="top" title="ลบ <?php echo $p_name; ?>" onclick="if(confirm('คุณต้องการลบข้อมูลนี้ใช่หรือไม่ ?')){window.location.href='<?php echo $p_url; ?>_function.php?process=delete&id=<?php echo $rec['LANG_ID']; ?>&WF_TYPE=<?php echo $WF_TYPE; ?>';}">
