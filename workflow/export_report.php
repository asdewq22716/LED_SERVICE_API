...
if($_POST["export_type"] == 'pdfl' or $_POST["export_type"] == 'pdfa3l'){
	...
	$mpdf = new \Mpdf\Mpdf(['format' => $size,'margin_left' => $margin_left,'margin_right' => $margin_right,'margin_top' => $margin_top,'margin_bottom' => $margin_bottom,'margin_header'=>$margin_header,'margin_footer'=>$margin_footer]);
	$std_css="<style>
	table{
...
//--- เพิ่ม ลายน้ำ logo ldo
	if($_POST['watermark_img']){
		$mpdf->SetWatermarkImage($_POST['watermark_img'],'0.2');
	...
	if($_POST['txt_footer']){
		$footer = stripslashes($_POST['txt_footer']);
	...
	div.watermarked:after {
		...
		top: 150px;
		left: 350px;
		background-image: url('../images/logo_ldo.png');
...
//--- เพิ่ม ลายน้ำ logo ldo
	...
	echo removeLink($_POST["header_xls"]);
	...
	if($_POST['page_type'] == "L"){ echo "<div class=\"pageL\">"; }
	echo removeLink($_POST["header_doc"]);	
