...
if($BSF_DET["WFS_OPTION_COND"] != ""){
	...
	$con = " AND ".bsf_show_field($BSF_DET["WF_MAIN_ID"],$WF,$BSF_DET["WFS_OPTION_COND"]);
	}else{
	$con = " AND ".bsf_show_field('',array(),$BSF_DET["WFS_OPTION_COND"]);	
	}
}
$t_array = array();
$t=0;
             ...
             <!--Workflow row start-->
                <div class="row">
					...
					if($rec_main["WF_MAIN_TOP_INCLUDE"] != "" AND file_exists("../plugin/".$rec_main["WF_MAIN_TOP_INCLUDE"])){ include("../plugin/".$rec_main["WF_MAIN_TOP_INCLUDE"]); }
						...
						?><form method="get" id="form_wf_search_h" name="form_wf_search_h" action="#" ">
						<h4><i class="icofont icofont-search-alt-2"></i> <?php echo $system_conf["conf_search"];?></h4>
								...
								<div class="form-group row">
									<div class="col-md-12 text-center">
										<button type="button" name="wf_search" id="wf_search"  class="btn btn-info" onClick="get_wfs_form('wf_hidden_content','../workflow/wf_main.php','form_wf_search_h','GET');"><i class="icofont icofont-search-alt-2"></i> <?php echo $system_conf["conf_search"];?></button>
										&nbsp;&nbsp;
										<a href="#!" name="wf_reset" id="wf_reset"  class="btn btn-warning" onClick="get_wfs_show('wf_hidden_content','../workflow/wf_main.php','W=<?php echo $W; ?>&WFS=<?php echo $WFS; ?>&WFR=<?php echo $WFR; ?>','GET');" ><i class="zmdi zmdi-refresh-alt"></i> Reset</a>
