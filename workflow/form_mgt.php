...
?>
					...
					<div class="main-header">
						<div class="media m-b-12">
							...
							<div class="media-body">
								<h4 class="m-t-5"><?php echo bsf_language("WFD",$rec_detail["WFD_ID"],$rec_detail["WFD_NAME"]);
								?></h4>
            ...
            <!-- Row end --> 
			<form method="post" enctype="multipart/form-data" id="form_wf_mgt" name="form_wf_mgt" target="TARGET<?php echo $WFS; ?>" action="../workflow/form_mgt_function.php">
             <!--Workflow row start-->
                <div class="row">
					<div class="col-md-12">
						<div class="card">
			...
			<div class="row">
				<div class="col-md-12">
                    <div align="center">&nbsp;
						...
						<input type="hidden" name="F_TEMP_ID2" value="<?php echo $F_TEMP_ID; ?>">
