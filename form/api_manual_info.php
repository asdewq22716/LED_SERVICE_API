            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <?php
                        $sqlLast = "SELECT a.* FROM M_API_SETTING a WHERE 1 = 1 AND (a.API_STATUS = '1' OR a.API_STATUS = '0') AND a.SERVICE_ID = '" . $SERVICE_ID . "' ORDER BY  a.API_SETTING_ID DESC ";
                        $qryLast = db::query($sqlLast);
                        $recLast = db::fetch_array($qryLast);

                        ?>
                        <div class="f-right">
                            <a href="#!" class="btn bg-primary active waves-effect waves-light" title=""
                                data-toggle="modal" data-target="#bizModalEdit"
                                onclick="open_modal('../all_modal/modal_response_edit.php?API_NAME=<?php echo $rec['SERVICE_NAME']; ?>&SETTING_ID=<?php echo $recLast['API_SETTING_ID']; ?>', '','Edit')">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT
                                                      ...
                                                      WHERE
                                                          1 = 1 
                                                          AND (a.API_STATUS = '1' OR a.API_STATUS = '0')
                                            ...
                                            <tr id="tr">
                                                ...
                                                <td class="">
                                                    <?php echo $rec["SERVICE_CODE"]; ?>&nbsp;
                                                    <?php echo ($rec["EXPORT_REPORT"] == 1) ? '<i class="fa fa-file-word-o"></i>' : '';?>
                                                </td>
                                                <td class=""><?php echo $rec["SERVICE_LIST"]; ?></td>
                                                <td class=""><?php echo $rec["API_DESC"]; ?></td>
                                                ...
                                                <td style="text-align:center;" class="td_remove">
                                                    <nobr>
                                                        ...
                                                        <a href="../form/api_manual_word_id.php?SETTING_ID=<?php echo $rec['API_SETTING_ID']; ?>&SERVICE_ID=<?php echo $_GET['SERVICE_ID']; ?>"  target="_blank" class="btn btn-primary btn-mini" title="">
                                                        ...
                                                        */?>
                                                        ...
                                                        <?php } else {?>
                                                            ...
                                                            <?php if ($_GET['devMode'] == 'D') { ?>
                                                                ...
                                                                <a href="#!" class="btn btn-success btn-mini" title=""
                                                                    data-toggle="modal" data-target="#bizModalEdit"
                                                                    onclick="open_modal('../all_modal/modal_response_dev_edit.php?SETTING_ID=<?php echo $rec['API_SETTING_ID']; ?>&show=A', '','Edit');$('#dm').val('A');">
                                                                    <i class="icofont icofont-ui-edit"></i> DEV <?php echo $rec['API_SETTING_ID']; ?>
                                                                </a>
                                                                <a href="#!" class="btn btn-success btn-mini" title=""
                                                                    data-toggle="modal" data-target="#bizModalEdit"
                                                                    onclick="open_modal('../all_modal/modal_response_dev_edit.php?SETTING_ID=<?php echo $rec['API_SETTING_ID']; ?>&show=S', '','Edit');$('#dm').val('S');">
                                                                    <i class="icofont icofont-ui-edit"></i> ร้องขอ <?php echo $rec['API_SETTING_ID']; ?>
                                                                </a>
                                                                <a href="#!" class="btn btn-success btn-mini" title=""
                                                                    data-toggle="modal" data-target="#bizModalEdit"
                                                                    onclick="open_modal('../all_modal/modal_response_dev_edit.php?SETTING_ID=<?php echo $rec['API_SETTING_ID']; ?>&show=R', '','Edit');$('#dm').val('R');">
                                                                    <i class="icofont icofont-ui-edit"></i> ตอบกลับ <?php echo $rec['API_SETTING_ID']; ?>
                                                                </a>
                                                            <?php }else{ ?>
                                                        ...
                                                        <a href="#!" class="btn btn-warning btn-mini" title=""
                                                            data-toggle="modal" data-target="#bizModalEdit"
                                                            onclick="open_modal('../all_modal/modal_response_copy.php?SETTING_ID=<?php echo $rec['API_SETTING_ID']; ?>', '','Edit')">
...
<script>
    function refresh_modal(settingId) {
        $('#bizModalEdit .modal-body').html('');
        <?php if ($_GET['devMode'] == 'D') { ?>
        var dm = $('#dm').val();
        open_modal('../all_modal/modal_response_dev_edit.php?SETTING_ID=' + settingId+'&show='+dm, '', 'Edit');
        <?php }else{ ?>
        open_modal('../all_modal/modal_response_edit.php?SETTING_ID=' + settingId, '', 'Edit');
        <?php } ?>
    }

    function open_add_list(type, settingId) {
        var width = 600;
        var height = 400;
        ...
        window.open('../all_modal/modal_temp_form_api.php?type=' + type + '&SETTING_ID=' + settingId, '', features);
    }

    function open_edit_list(type, settingId, apiListId) {
        var width = 600;
        var height = 400;
        ...
        var features = 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top;
        window.open('../all_modal/modal_temp_form_api.php?type=' + type + '&SETTING_ID=' + settingId + '&API_LIST_ID=' + apiListId, '', features);
    }
</script>