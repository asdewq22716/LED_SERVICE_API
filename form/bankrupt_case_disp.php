                ...
                <div class="main-header">
                    ...
                    <div class="media m-b-12">
                        ...
                        <div class="media-body">
                            ...
                            <h4 class="m-t-5">&nbsp;</h4>
                            <h4>ระบบฐานข้อมูลกลางล้มละลาย</h4>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div id="wf_space" class="card-header">
                        ...
                        <form method="get" id="form_wf_search" name="form_wf_search" action="#">
							<div class="col-md-12 text-right">
                                    ...
                                    <button type="button" name="wf_search" id="wf_search" class="btn btn-info" onclick="getCase();">

                                         <i class="zmdi zmdi-refresh-alt"></i> ดึงข้อมูลคดีล้มละลาย

                                    </button>&nbsp;&nbsp;

                                    <button type="button" name="wf_reset" id="wf_reset" class="btn btn-warning" onclick="getPerson();">
                                    
                                        <i class="zmdi zmdi-refresh-alt"></i> ดึงข้อมูลบุคคลล้มละลาย
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" name="wf_reset" id="wf_reset" class="btn btn-warning" onclick="window.location.href='bankrupt_case_disp.php';">
                    ...
                    <?php
						...
						if($_GET['PREFIX_RED_CASE']){

                            $filter .= " AND PREFIX_RED_CASE = '".$_GET['PREFIX_RED_CASE']."'";

                        }

                        if($_GET['RED_CASE']){

                            $filter .= " AND RED_CASE = '".$_GET['RED_CASE']."'";

                        }

                        if($_GET['RED_YY']){

                            $filter .= " AND RED_YY = '".$_GET['RED_YY']."'";
                        ...
                        <div class="table-responsive" data-pattern="priority-columns" id="export_data">
                            ...
                            <div class="showborder">
                                ...
                                <table cellspacing="0" id="tech-companies-1" class="table table-bordered sorted_table">
									...
									<?php
										$i = 1;
										while($data = db::fetch_array($qry_bankrupt)){
										$blackCase = $data['PREFIX_BLACK_CASE'].$data['BLACK_CASE']."/".$data['BLACK_YY'];	
										$redCase = $data['PREFIX_RED_CASE'].$data['RED_CASE']."/".$data['RED_YY'];
										$plaintiff = $data['PLAINTIFF1'];
										$deffendant = $data['DEFFENDANT1'];
									?>
                                        <tr id="tr">

                                            <td style="text-align:center;"><?php echo $i; ?></td>
                                            <td class=""><?php echo $data['COURT_NAME']; ?></td>
                                            <td class=""><?php echo $blackCase; ?></td>
                                            <td class=""><?php echo $redCase; ?></td>
                                            <td class=""><?php echo $plaintiff; ?></td>
                                            <td class=""><?php echo $deffendant; ?></td>
...
<script>
	...
	function getCase(){
		...
		$.ajax({
			url  : "../service/bankruptCaseDetail.php",
			type : "POST",
			cache: false,
