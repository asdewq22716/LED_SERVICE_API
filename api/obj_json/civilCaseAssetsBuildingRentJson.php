<?php
class civilCaseAssetsBuildingRentJson{
	...
	public function getJson(){
		...
		$this->objJson = array(
			  ...
			  "service_info" => "รายละเอียดทรัพย์สิทธิการเช่า (ห้องชุด,พื้นที่ขาย)",
			  "request" => array(
			...
			"response" => array(
				...
				"CFC_BD_RENT_RIGHT_REQ_GEN" => array(
					...
					"TYPE" => "number",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "เลขสิทธิการเช่าห้องชุดที่ขอยึด",
					"EX" => ""
				),
				"CFC_CIVIL_GEN" => array(
					"FIELD" => "cfcCivilGen",
