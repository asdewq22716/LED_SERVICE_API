	...
	public function getJson(){
		...
		$this->objJson = array(
			...
			"response" => array(
				...
				"CFC_VEHICLE_REQ_GEN" => array(
					"FIELD" => "cfcVehicleReqGen",
					"TYPE" => "number",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "เลขยานพาหนะที่ขอยึด",
					"EX" => ""
				),
				"SEQ_NO" => array(
					"FIELD" => "seqNo",
				...
				"VEHICLE_REGISTRATION_FLAG" => array(
					"FIELD" => "vehicleRegistrationFlag",
					"TYPE" => "string",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "ประเภททรํพย์",
					"EX" => "ว่าง = ไม่ระบุ 
