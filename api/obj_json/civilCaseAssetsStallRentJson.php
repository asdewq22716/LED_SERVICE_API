<?php
class civilCaseAssetsStallRentJson{
	...
	public function getJson(){
		...
		$this->objJson = array(
			  "code" => "",
			  "service_name" => "civilCaseAssetsStallRent",
			  "service_info" => "รายละเอียดทรัพย์สิทธิการเช่า (แผงลอย)",
			  "request" => array(
			...
			"response" => array(
				...
				"CFC_LAND_RENT_RIGHT_GEN" => array(
					"FIELD" => "cfcLandRentRightGen",
					"TYPE" => "number",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "เลขสิทธิการเช่าแผงลอย",
					"EX" => ""
				),
				"CFC_CIVIL_GEN" => array(
					"FIELD" => "cfcCivilGen",
				...
				"CFC_LAND_RENT_RIGHT_REQ_GEN" => array(
					"FIELD" => "cfcLandRentRightReqGen",
					"TYPE" => "number",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "เลขสิทธิการเช่าแผงลอยที่ขอยึด",
					"EX" => ""
				),
				"SEQ_NO" => array(
					"FIELD" => "seqNo",
				...
				"RENT_TYPE" => array(
					...
					"EX" => "ที่ดินพร้อมสิ่งปลูกสร้าง, แผงลอย"
				),
				"VILLAGE_NAME1" => array(
					"FIELD" => "villageName1",
					"TYPE" => "string",
				...
				"CENT_LOC_GEN1" => array(
					...
					"TYPE" => "number",
					"FIELD_TYPE" => "M", // M/O
					"DESC" => "เลขที่ตั้งทรัพย์สิ่งปลูกสร้าง",
					"EX" => ""
				),
				"POST_CODE" => array(
					"FIELD" => "postCode",
