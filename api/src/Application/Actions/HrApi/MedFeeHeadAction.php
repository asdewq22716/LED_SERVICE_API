...
class MedFeeHeadAction extends Action
{
    /**
     * {@inheritdoc}
     */	 
    ...
    {        
		...
		while($r = \db::fetch_array($q)){
			...
			$row['MedicalFeeDisbursementsNumber'] = $r['WELFARE_NO'];
			$row['MedicalFeeDisbursementsDate'] = $r['WELFARE_DATE'];
