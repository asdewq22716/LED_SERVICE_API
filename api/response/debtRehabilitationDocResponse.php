<?php
class debtRehabilitationDocResponse extends debtRehabilitationDoc {
	...
	public function getResponse(){
		...
		$this->resPonse = false;		
		$this->json = debtRehabilitationDoc::getJson();
		...
		DEFFENDANT1,DEFFENDANT2,DEFFENDANT3,RECORD_COUNT,SEQ,DOC_DATE,DOC_NAME,DOC_FILE
		FROM WH_REHABILITATION_DOCS WHERE 1 = 1 {$filter}";
