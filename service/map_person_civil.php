...
if($res['userName'] == 'BankruptDt' && $res['passWord'] == 'Debtor4321' && $res['systemType'] == 'Civil'){
  ...
  $obj['courtCode'] = $qry_data['COURT_CODE_LAW'];
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => 'http://103.208.27.224/ega_led_mediate/save/insert_cmd_person_civil.php',
