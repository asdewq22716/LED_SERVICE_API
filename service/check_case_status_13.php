...
$REGISTERCODE = "";
$CONCERN_CODE = "";
$data_array = $POST["PERSON_CONCERN"];
foreach ($data_array as $A1 => $ac1) {
    $REGISTERCODE .=  $ac1["REGISTERCODE"] . (count($data_array) == $text_N ? "" : ",");
    $CONCERN_CODE .= $ac1["CONCERN_CODE"]  . (count($data_array) == $text_N ? "" : ",");
    $text_N++;
}
...
unset($fields);
$fields["PAGE_CODE"]                 =    $POST['PAGE_CODE'];
