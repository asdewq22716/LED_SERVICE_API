...
$data = json_decode($str_json, true);
	...
	$sql = "SELECT COUNT(*) AS NR FROM WH_CIVIL_CASE_ASSETS_MACHINE WHERE ASSET_CODE = '".$data['cfcMachineGen']."'";
	$query = db::query($sql);
	$rec = db::fetch_array($query);
	...
	if($rec['NR'] > 0){
		...
		$update['MACHINE_NAME']   	= 	$data['machineName'];
		$update['MACHINE_SIZE']   	= 	$data['machineSize'];
        $update['BRAND_NAME']   	= 	$data['brandName'];
		$update['COLOUR']   	    = 	$data['colour'];
        $update['MACHINE_MODEL']   	= 	$data['machineModel'];
		$update['ENGINE_NO']   	    = 	$data['engineNo'];
        $update['LICENSE_NO']   	= 	$data['licenseNo'];
		$update['MACHINE_COMMENT']  = 	$data['machineComment'];
		$update['ADDR_NO']  	    = 	$data['addrNo'];
		$update['MOO_NO'] 	  	    = 	$data['mooNo'];
        $update['PROJECT_NAME']     = 	$data['projectName'];
		...
		$cond['ASSET_CODE']			 = $data['cfcMachineGen'];
		
		db::db_update("WH_CIVIL_CASE_ASSETS_MACHINE",$update,$cond);
		...
		$insert['ASSET_CODE']		    =   $data['cfcMachineGen'];
		$insert['ASSET_TYPE']		    =	'';
		...
		$insert['MACHINE_NAME']   	    = 	$data['machineName'];
		$insert['MACHINE_SIZE']   	    = 	$data['machineSize'];
        $insert['BRAND_NAME']   	    = 	$data['brandName'];
		$insert['COLOUR']   	        = 	$data['colour'];
        $insert['MACHINE_MODEL']   	    = 	$data['machineModel'];
		$insert['ENGINE_NO']   	        = 	$data['engineNo'];
        $insert['LICENSE_NO']   	    = 	$data['licenseNo'];
		$insert['MACHINE_COMMENT']      = 	$data['machineComment'];
		$insert['ADDR_NO']  	        = 	$data['addrNo'];
		$insert['MOO_NO'] 	  	        = 	$data['mooNo'];
        $insert['PROJECT_NAME']         = 	$data['projectName'];
		$insert['FLOOR']		        = 	$data['floor'];
        $insert['SOI'] 	  	            = 	$data['soi'];
		$insert['ROAD'] 		  	    = 	$data['road'];
		$insert['CENT_LOC_GEN']	        = 	$data['centLocGen'];
		
		db::db_insert("WH_CIVIL_CASE_ASSETS_MACHINE",$insert,'ASSET_ID','ASSET_ID');
