...
$data = json_decode($str_json, true);
	...
	$sql = "SELECT COUNT(*) AS NR FROM WH_CIVIL_CASE_ASSETS_LAND WHERE ASSET_CODE = '".$data['cfcLandGen']."'";
	$query = db::query($sql);
	$rec = db::fetch_array($query);
	...
	if($rec['NR'] > 0){
		...
		$update['AREA_WA'] 		  	 = 	$data['va'];
		$update['AREA_FRACTION_WA']	 = 	$data['partRemainVa'];
		$update['LAND_PRICE_PER_WA'] = 	$data['estPerVaAmount'];
		$update['LAND_PRICE'] 	   	 = 	$data['estAreaAmount'];
		$update['DETAIL'] 			 = 	$data['landComment'];
		...
		$cond['ASSET_CODE']			 = $data['cfcLandGen'];
		
		db::db_update("WH_CIVIL_CASE_ASSETS_LAND",$update,$cond);
		...
		$insert['ASSET_CODE']		 =  $data['cfcLandGen'];
		$insert['ASSET_TYPE']		 =	'01';
		...
		$insert['AREA_WA'] 		  	 = 	$data['va'];
		$insert['AREA_FRACTION_WA']	 = 	$data['partRemainVa'];
		$insert['LAND_PRICE_PER_WA'] = 	$data['estPerVaAmount'];
		$insert['LAND_PRICE'] 	   	 = 	$data['estAreaAmount'];
		$insert['DETAIL'] 			 = 	$data['landComment'];
		$insert['DEED_NO']			 = 	$data['deedNo'];
		$insert['CENT_LOC_GEN']		 = 	$data['centLocGen'];
		$insert['MOO_NO']			 = 	$data['mooNo'];
		
		db::db_insert("WH_CIVIL_CASE_ASSETS_LAND",$insert,'ASSET_ID','ASSET_ID');
		...
		$WH_ASSET_ID = db::db_insert("WH_CIVIL_CASE_ASSETS",$insertMap,'WH_ASSET_ID','WH_ASSET_ID');
