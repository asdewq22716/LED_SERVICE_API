...
$field['REQUEST'] = 'getVerifyPersonNewaa';
...
if(!empty($POST['registerCode2'])){
	$registerCode2 = str_replace('-','',$POST['registerCode2']);
}
...
if($POST["fromSystemType"]!=""){
	$request_contents["fromSystemType"] = $POST["fromSystemType"];
}
