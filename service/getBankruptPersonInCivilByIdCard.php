...
$WF_GET_BANKRUPT_PERSON_IN_CIVIL_BY_IDCARD = "http://103.40.146.73/LedServiceCivilById.php/getBankruptPersonInCivilByIdCard";
...
function getBankruptPersonInCivilByIdCard($idCard, $show_data, $option = '')
{
    global $WF_GET_BANKRUPT_PERSON_IN_CIVIL_BY_IDCARD;

    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => $WF_GET_BANKRUPT_PERSON_IN_CIVIL_BY_IDCARD,
...
$dataReturn = getBankruptPersonInCivilByIdCard($idCard, $show_data, 'N');
