...
CREATE TABLE `m_location` (
  ...
  `LOC_NAME_TH` varchar(500) DEFAULT NULL,
  `LOC_NAME_EN` varchar(500) DEFAULT NULL
...
INSERT INTO `m_location` VALUES (1,'เชียงใหม่','Chiang mai'),(2,'กัมพูชา','Cambodia'),(1,'เชียงใหม่','Chiang mai'),(2,'กัมพูชา','Cambodia');
