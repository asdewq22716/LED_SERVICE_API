<?php
$defendant = db::query("SELECT * FROM WH_MEDIATE_PERSON WHERE WH_MEDIATE_ID = '".$_GET['WFR']."' AND CONCERN_NAME = 'จำเลย/ลูกหนี้'");
?>
		...
		if($num > 0){
	        ...
	        $registerCode = "";
				...
				<td style=\"width:15%;\" class=\"text-center\">
					<a class=\"btn btn-info btn-mini\" href=\"\" onclick=\"open_modal('../all_modal/person_address_info.php?defendant=".$defen['WH_PERSON_ID']."&sys=mediate', '','')\" data-toggle=\"modal\" data-target=\"#bizModal\">
