		...
		if ($num > 0) {
			while ($plain = db::fetch_array($plaintiff)) {
				...
				<td style=\"width:15%;\" class=\"text-center\">
					<a class=\"btn btn-info btn-mini\" href=\"\" onclick=\"open_modal('../all_modal/person_address_info.php?plaintiff=" . $plain['WH_PERSON_ID'] . "&sys=civil', '','')\" data-toggle=\"modal\" data-target=\"#bizModal\">
